...
- english
- ai-translation
title: App Store Connect API Webhook｜Automate CI/CD Workflows Seamlessly
---
...
> *Webhooks allow a system to send real-time data to another system over the web.*

> *Webhook allows a system to instantly send data to another system over the network.*

> *Unlike traditional APIs, where one system must make a request to receive data, a webhook allows you to push data to the receiving system immediately when an event occurs.*

> *Unlike traditional APIs, which require the receiver to actively send a request, Webhooks can instantly push data to the receiving system as soon as the event occurs.*
...
> *Webhook is event-driven, meaning it immediately sends relevant data to a pre-configured URL, known as the "Webhook URL" or "Callback URL," when a specific action or event is triggered.*

> *A notification webhook is an endpoint you create on your server.*

> *Notification Webhook is an endpoint you set up on your own server.*
...
> *Use the webhooks notifications endpoint to configure notifications for events occurring in your apps.*

> *You can use Webhook notification endpoints to set up notifications for various events that occur with your App.*
