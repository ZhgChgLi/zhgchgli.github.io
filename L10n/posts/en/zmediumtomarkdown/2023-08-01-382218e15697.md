...
description: Learn how to use Google Apps Script to connect Github Webhook and instantly
  send star notifications to Line, solving the hassle of manual tracking and boosting
  your repo engagement effortlessly.
image:
...
- english
- ai-translation
title: Google Apps Script｜Create Free Github Repo Star Notifier in 3 Steps
---
...
First, consider finding existing tools. I searched at [Github Marketplace](https://github.com/marketplace?type=apps&query=Star+Notifier+){:target="_blank"} and found several well-made tools available.
...
The [Github](https://apps.apple.com/tw/app/github/id1477376905){:target="_blank"} App on iOS or third-party apps like [GitTrends](https://github.com/brminnick/GitTrends){:target="_blank"} do not support this feature either.
...
> *Since Line Notify will be [shutting down on 2025/04/01](https://notify-bot.line.me/closing-announce){:target="_blank"}, please refer to **my latest article "[Quickly migrate Line Notify to Telegram Bot notifications in 10 minutes](../6922e90ba90c/)"** to switch to Telegram for notification integration.*
...
> Due to [GAS limitations](https://issuetracker.google.com/issues/67764685?pli=1){:target="_blank"}, it is not possible to access `Headers` in `doPost(e)`. Therefore, the Github Webhook [standard authentication method](https://docs.github.com/en/webhooks-and-events/webhooks/securing-your-webhooks){:target="_blank"} cannot be used. Instead, manual string matching verification with a `?secret=` query parameter must be used.
...
*[Post](https://medium.com/zrealm-robotic-process-automation/%E4%BD%BF%E7%94%A8-google-apps-script-%E4%B8%89%E6%AD%A5%E9%A9%9F%E5%85%8D%E8%B2%BB%E5%BB%BA%E7%AB%8B-github-repo-star-notifier-382218e15697){:target="_blank"} converted from Medium by [ZMediumToMarkdown](https://github.com/ZhgChgLi/ZMediumToMarkdown){:target="_blank"}.*