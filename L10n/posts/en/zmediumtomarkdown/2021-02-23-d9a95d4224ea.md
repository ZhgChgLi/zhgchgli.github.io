...
categories:
- ZRealm Life.
date: 2021-02-23 18:25:15.743000000 +00:00
description: Struggling to grow your online presence? Medium's custom domain feature
  lets you build and control your own domain authority seamlessly, enhancing your
  brand visibility and credibility.
image:
  path: "/assets/d9a95d4224ea/1*Yoz3gwb9HPe2d-ja6Y8W-Q.png"
last_modified_at: 2024-09-22 09:16:55.922000000 +00:00
...
This feature has had a bumpy history: it was launched in 2012, then closed; reopened in 2021, and announced closed again in 2022. Recently in 2024, it returned, and the official documentation has been fully updated. You can refer to the latest official guide for setup, and [for domain registration instructions, see this article](https://namecheap.pxf.io/P0jdZQ){:target="_blank"}.
...
Purchase a domain of your choice from [Namecheap](https://namecheap.pxf.io/P0jdZQ){:target="_blank"} (used as an example here) or Godaddy. Common .com domains usually cost around NT$200–500 per year; prices vary based on the domain extension and length, with rare ones sometimes costing millions or even billions.
...
> *By the way, my domain zhgchg.li is an example of a [Domain Hack](https://zh.wikipedia.org/wiki/%E5%9F%9F%E5%90%8Dhack){:target="_blank"}; a better example is google => goo.gl.*
...
> *⭐️⭐️⭐️ **The purchased domain can also be used for: [Github Pages](../483af5d93297/)***
...
*[Post](https://medium.com/zrealm-life/medium-%E8%87%AA%E8%A8%82%E7%B6%B2%E5%9F%9F%E5%8A%9F%E8%83%BD%E5%9B%9E%E6%AD%B8-d9a95d4224ea){:target="_blank"} converted from Medium by [ZMediumToMarkdown](https://github.com/ZhgChgLi/ZMediumToMarkdown){:target="_blank"}.*