...
categories:
- ZRealm Dev.
date: 2019-07-24 14:32:34.350000000 +00:00
description: Discover how to create captivating Engineering Capture The Flag competitions
  by designing effective challenges that engage participants and enhance problem-solving
  skills, ensuring an exciting and educational experience.
image:
  path: "/assets/729d7b6817a4/1*w3Yf4Wuhv9LqFVPHMjHquQ.png"
last_modified_at: 2024-04-13 07:53:50.386000000 +00:00
...
- english
- ai-translation
title: 'Engineering CTF Competition Guide: Build Engaging Capture The Flag Challenges'
---
...
1. The purpose of hosting a CTF competition, besides improving technical skills, is also to **promote communication among engineers**.
...
3. Groups should balance strengths and evenly distribute expertise across domains.

4. The event lasts at most one afternoon.

5. Organizing a CTF competition is a side project outside the main work duties, with limited resources and time.
...
3. Inspiring everyone's passion and curiosity for exploration

4. Fun activities are enjoyable; boring ones are painful to do
...
1. Divide engineers into balanced groups based on their expertise and strengths.

2. Competition Time: 90 minutes

3. There are a total of 12 questions, with 3 chances to purchase hints using points.

4. Hint purchase cost decreases over time (the earlier you buy, the more expensive it is)

5. Each question has a base score plus a time score (the earlier you solve, the more points you get)

6. Once a challenge is opened for answering, participants can only submit answers for that challenge or other already opened challenges until the challenge is solved or the lock time expires.  
...
7. Each question's score, hint cost, and lock time vary according to the difficulty level.

8. Victory Conditions: The team with the highest total score wins. If scores are tied, the team with the shorter total solving time wins.

9. Winning teams have $$
...
![Hovering the mouse shows time score and hint price](/assets/729d7b6817a4/1*r9PLQICTpLTcModIKP2G8g.jpeg)
...
This challenge is not about bypassing frontend validation, as the backend handles it and cannot be bypassed. The main focus is the [32-bit 2038 problem](https://zh.wikipedia.org/wiki/2038%E5%B9%B4%E9%97%AE%E9%A2%98){:target="_blank"}. Due to the 32-bit limit, the timestamp can only represent dates up to January 19, 2038, 03:14:07. Beyond this, it will overflow back to January 1, 1901. Therefore, by inputting dates from `2073–02–06 to 2074–02–05`, which correspond to 1937 after overflow, the submission will succeed!
...
For example: the main mailbox is `zhgchgli@gmail.com`, but emails sent to z.hgchgli@gmail.com, zh.gchgli@gmail, zhgchgli+1@gmail.com, zhgchgli+25@gmail.com… will all arrive at the main mailbox `zhgchgli@gmail.com`. One mailbox can create multiple identities!
...
This image has secretly compressed a text file inside it (for the actual method, please refer to: [How To Hide A ZIP File Inside An Image On Mac [Quicktip]](https://www.hongkiat.com/blog/hide-zip-image-mac/){:target="_blank"}). Note the differences between Windows and Mac here.
...
![[Steganography and Malware: Principles and Methods](https://blog.trendmicro.com.tw/?p=12510){:target="_blank"}](/assets/729d7b6817a4/1*WfSUbQXSjTOg28ZWsihMHg.png)
...
![Image sourced from the internet](/assets/729d7b6817a4/1*PZz3sUOhaUNKRmNS_jY1RA.png)
...
This challenge is actually quite straightforward and doesn't require overthinking; frequent users of encoding should recognize that this jumble of characters is just a base64 string. Let's first [decode it](https://www.base64encode.org/){:target="_blank"}, and we get:
...
![[Common PHP Vulnerabilities in CTF Summary](https://xz.aliyun.com/t/3085){:target="_blank"}](/assets/729d7b6817a4/1*iITV3WJTJHez1xRpul6uTA.png)

[Common PHP Vulnerabilities in CTF](https://xz.aliyun.com/t/3085){:target="_blank"}
...
This challenge has its solution placed on the frontend, using a JS website that provides irreversible encryption: <https://www.sojson.com/jsobfuscator.html>{:target="_blank"}
