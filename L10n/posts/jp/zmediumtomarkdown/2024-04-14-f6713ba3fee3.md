...
description: Google Apps Scriptを活用し、Google Workspaceのサービスを自動化。毎日のデータレポート作成の手間を削減し、効率的な業務運用を実現します。
image:
...
- japanese
- ai-translation
title: Google Apps Scriptで実現｜毎日データレポートのRPA自動化方法
---
...
以前「[**2021 Pinkoi Tech Career Talk — 高効率エンジニアチームの秘密**](../11f6c8568154/)」で積み重ねとフローの中断コストについて共有しました。例えば、定型的な繰り返し作業が1回15分かかり、週に10回発生すると、年間で約130時間を浪費します。さらに「フロー切り替え」コストを加えると、最終的には年間で約200時間を浪費する可能性があります。

![[**2021 Pinkoi Tech Career Talk — 高効率エンジニアチームの秘密**](../11f6c8568154/)](/assets/f6713ba3fee3/1*U6bzH6b5-PRxFBktvkOa2Q.png)
...
- Low Code： [Google Apps Script](https://www.google.com/script/start/){:target="_blank"}（無料サービス）、簡単なコードを書くことでGoogleサービスや外部／内部システムと素早く直接連携できます。

- Function as a Service： [Cloud Functions](https://cloud.google.com/functions?hl=zh_tw){:target="_blank"}（有料サービス、無料枠あり）、完全なコードやサービスを作成し、Google Cloud を通じて直接実行します。

No Code プラットフォームの [App Sheet](https://cloud.google.com/appsheet#pricing){:target="_blank"} は使ったことがありませんが、[Cloud Functions](https://cloud.google.com/functions?hl=zh_tw){:target="_blank"} と [Google Apps Script](https://www.google.com/script/start/){:target="_blank"} はかなり経験があります。以下は個人的な使用と選択の経験の共有です：
...
- [自動チェックインロボット]： [Python+Google Cloud Platform+Line Botを使った定期作業の自動実行](../70a1409b149a/)
...
- **セキュリティ上の問題により、[Request User-Agent 情報のカスタマイズはできません](https://issuetracker.google.com/issues/36758197){:target="_blank"}**
...
- [Slack x Google Form x Google Sheet 連携]： [Slackで作る完全自動WFH従業員健康状況報告システム](../d61062833c1a/)

- [Slack と Gmail の連携]： [Google Apps Script を使って Gmail メールを Slack に転送する方法](../d414bdbdb8c9/)

- [Google Analytics と Slack の連携]： [Crashlytics + Google Analytics 自動で App のクラッシュフリー率を取得](../793cb8f89b72/)

- [Firebase Crashlytics x Big Query x Slack 連携]： [Crashlytics + Big Query でよりリアルタイムで便利なクラッシュ追跡ツールを作る](../e77b80cc6f89/)

- [Github と LineBot の連携]： [Google Apps Script を使って3ステップで無料で Github リポジトリのスター通知を作成する](../382218e15697/)
...
> **対応する Google Sheet をリンクしなくても操作可能**で、どちらの作成方法でも問題ありません。違いはスクリプトの所有権が誰に属するかです。リンクされたレポートの場合はレポートの所有者に、自己作成の場合は作成者に帰属します。所有者は、そのアカウントが退職などで無効になった場合にスクリプトが動作しなくなったり削除されたりするかに関係します。
...
[**Google Apps Script GitHub Assistant Chrome 拡張版 コントロールプラグイン**](https://chromewebstore.google.com/detail/lfjcgcmkmjjlieihflfhjopckgpelofo){:target="_blank"}
...
![(プログラムを修正して今月のデータを補完、さもなければ新しいデータには昨日の1件だけが含まれます)](/assets/f6713ba3fee3/1*8SRT_wSe2aQGzcqpRt2Qjw.png)
...
> **[ZhgChgLi](https://twitter.com/zhgchgli){:target="_blank"} @ Twitter は次のように述べています：**
...
もしあなたやチームが自動化ツールやプロセス連携のニーズがある場合、Slackアプリ開発、Notion、Asana、Google Sheet、Google Form、GAデータなど、あらゆる連携のご要望に対応します。ぜひ[**開発お問い合わせ**](https://zhgchg.li/contact/){:target="_blank"}ください。

ご質問やご意見がありましたら、ぜひ [お問い合わせ](https://www.zhgchg.li/contact){:target="_blank"} ください。

*[Post](https://medium.com/zrealm-robotic-process-automation/%E4%BD%BF%E7%94%A8-google-apps-script-%E5%AF%A6%E7%8F%BE-google-%E6%9C%8D%E5%8B%99-rpa-%E8%87%AA%E5%8B%95%E5%8C%96-f6713ba3fee3){:target="_blank"} Mediumから変換 by [ZMediumToMarkdown](https://github.com/ZhgChgLi/ZMediumToMarkdown){:target="_blank"}.*