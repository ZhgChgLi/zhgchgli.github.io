...
> *先用 AI 重構了幾個開源專案的應用層面，因而得到啟發也讓他做深入的 Foundation 資料結構設計。*
...
> [*mcp-medium-reader*](https://github.com/ZhgChgLi/mcp-medium-reader){:target="*blank"} _能讓你的 AI 穿透封鎖並且讀取 Markdown 版本的 Medium 文章，節省 Token 的同時又能提升 AI 理解性。*
