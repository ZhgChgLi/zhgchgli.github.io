...
這次 iOS ≥13.1 (注意是 13.1 之後才開放)，內建的「 [捷徑](https://apps.apple.com/tw/app/%E6%8D%B7%E5%BE%91/id915249334){:target="_blank"} 」APP ( 若找不到請從 Store 下載回來) 支援自動化功能；如同 IFTTT、米家智慧，只是現在不用再特別使用第三方APP囉！
