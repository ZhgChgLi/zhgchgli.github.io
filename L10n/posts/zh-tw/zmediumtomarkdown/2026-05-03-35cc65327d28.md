...
last_modified_at: 2026-05-08T16:56:44.104+0000
...
#### 案例 (3) — [Jekyll Blog 自訂主題設計｜用 Claude Design + Claude Code 快速打造專屬風格](../6bf79c5b4dab/) ⬅️


> _花了一個週末的午後時光用 Claude Design 設計喜歡的 Blog 樣式與功能，再透過 Claude Code 實作並套用回 Jekyll Blog，把用了 5 年的 Chirpy Theme 介面完美替換成我心目中理想的個人 Blog 樣式。_ 
