...
![](/assets/d61062833c1a/1*brnD44gjwyWEyK14dQYfxQ.jpeg){:target="_blank"}
...
![圖片取自： [海總理](https://www.facebook.com/tzangms/posts/10157880898787657){:target="_blank"}{:target="_blank"}](/assets/d61062833c1a/1*yKBpGlHEVMj4QbjGuB7aHQ.jpeg)
...
![](/assets/d61062833c1a/1*jT5dAICg85lyCF0sJwk8bQ.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*xbZD2kkoYvWifQv8qyV_MQ.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*DKVg1oWvx0p2K_aYslK5ZQ.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*Ie0WvV5zWNubaYq_hBbeNw.jpeg){:target="_blank"}
...
![](/assets/d61062833c1a/1*1A3m2zx1hI039TgWt3iU5A.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*pkCpzbA6YLORazNfQS2ntA.jpeg){:target="_blank"}


於 Slack 任意對話視窗中找到「 **輸入匡 下方** 」的「藍色閃電⚡️」點擊下去


![](/assets/d61062833c1a/1*GpUOoQ2b_W7bMeeOlkosoA.jpeg){:target="_blank"}


在選單底下「Search shortcuts」中輸入「workflow」選擇「Open Workflow Builder」


![](/assets/d61062833c1a/1*qgt-WjyrG_5OtaUjjt6r9Q.jpeg){:target="_blank"}


這邊會列出你建立的或參與的 Workflow，點選右上角「Create」建立新 Workflow


![](/assets/d61062833c1a/1*3qUC2S7sskImnDmXcnqMtg.jpeg){:target="_blank"}


第一步，輸入 workflow 名稱（Workflow Builder 介面顯示用）


![](/assets/d61062833c1a/1*q94eI0z8ljhBrjrPEGWa8w.jpeg){:target="_blank"}
...
![](/assets/d61062833c1a/1*2NEcjJtkDwuQtF-DmnhgOg.jpeg){:target="_blank"}
...
![](/assets/d61062833c1a/1*Qq-nJr66qoGsXxhPEsUhWw.jpeg){:target="_blank"}


Shortcut 建立完成！開始建立 workflow 步驟，點擊「Add Step」加入步驟


![](/assets/d61062833c1a/1*aUerPfBPlOhkNGoeiougGA.jpeg){:target="_blank"}


選擇「Send a form」Step


![](/assets/d61062833c1a/1*DBPCTHNyKBuJIvEJCyexyg.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*pYIUTLaHVzHzFkAypN2_sw.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*hb1l9_E8EmHgUqIvHuBqhw.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*WsHqG3hxgivNfFXakMgVrQ.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*xyrdyrx9ACpWTcjAtG-rTQ.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*da6ofGd-N0NsBs4LNDsllQ.png){:target="_blank"}


繼上一步後，點擊「Add Step」加入新步驟，我們選擇 Google Sheets for Workflow Builder 的「Add a spreadsheet row」步驟。


![](/assets/d61062833c1a/1*6h_t9tPiam735pth-n0AOw.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*XPwkmIHRj8WKEM27kH3YQg.png){:target="_blank"}


點擊右下角「Insert Variable」選擇「Response to 問題一…」，插入之後可由左下角「Add Column」加入其他欄位，以此類推完成問題二、問題三…\.


![](/assets/d61062833c1a/1*wX7vJDvdneYrid0nECUIeg.png){:target="_blank"}


填寫人的 Email，可選擇「Person who submitted form」


![](/assets/d61062833c1a/1*lQqJ0x7CeVK9u7g2R2VktQ.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*CYKDEtnuCKuSgSbAbunB4A.png){:target="_blank"}


Timestamp 欄位比較 tricky 等下再補充設定方法，先點「Save」儲存後回到頁面右上角按「Publish」發布 Shortcut。


![](/assets/d61062833c1a/1*k4rJidYWiVHgco3NYxmA3w.png){:target="_blank"}


看到發布成功訊息後，可以回到 Slack Channel 試試看。


![](/assets/d61062833c1a/1*XaQ75kM9BnKgcmAEl63fPg.png){:target="_blank"}


這時候點閃電之後會出現剛剛建立的 Workflow form，可以點來填寫玩玩。


![](/assets/d61062833c1a/1*W5v-uUjhVTik05TLDwM-uQ.png){:target="_blank"}



![左：電腦 / 右：手機版](/assets/d61062833c1a/1*63CaYi-HlPWRqxExL-GseQ.jpeg){:target="_blank"}
...
![](/assets/d61062833c1a/1*xt7JeHRojIWgJCYrw8sKdw.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*54QcEy5QPBt3VXuRSe7-Vw.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*5lIcdnMQnmglNxaiY8fNUQ.png){:target="_blank"}


往下滑選擇「Update a spreadsheet row」


![](/assets/d61062833c1a/1*kRBL8iptGYd2Gsy7Lv6gGA.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*H8pb9TKvazhqiKKSCKcwCQ.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*avXovKvXz9mlHOq2NWaf3A.png){:target="_blank"}


回到編輯頁後再點一次「Add Step」加入新步驟，這次選「Select a spreadsheet row」我們要讀取 Timestamp 出來。


![](/assets/d61062833c1a/1*xEbDUkWd3utQ9QpllqSNHg.png){:target="_blank"}


Search 部分同「Update a spreadsheet row」，按「Save」。


![](/assets/d61062833c1a/1*VO3lfeTe1bxlL3xN3_wtwQ.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*8IH_AJZn0YHFk5obccmUYg.png){:target="_blank"}


拉到最下面按左下角「Add Column」在點右下角「Insert a variable」，找到「Select a spreadsheet」Section 中的「Timestamp」變數，注入進去。


![](/assets/d61062833c1a/1*-4vk8fjRwkIVSY4Pu-C6VA.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*GyJ-55XxVEcZ6Cb1Q_H-WQ.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*16JMg7a_YzUHnnY6JtBrGw.png){:target="_blank"}


這次選擇「Send a message」


![](/assets/d61062833c1a/1*2CJuPDtuaTM9P5wIKwPspQ.png){:target="_blank"}


「Send this message to」選擇「Person who submitted form」


![](/assets/d61062833c1a/1*xKh_l7A-z31B6rQPboFTAA.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*gfTjTnaNmu-aPj0MuF6M_Q.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*04KBQF7e4lCjQm5XeHgVrA.png){:target="_blank"}


首先在 Google Sheet 上方工具欄選擇「Tools」\->「Script editor」


![](/assets/d61062833c1a/1*wlg8D_1DHONj__M1dSBCxw.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*T5ExI_5aSf7QY5Zj_gJ3eg.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*XvugOM6drupik0wejbBnnA.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*BG70QTiE-8QNvlp31jDBMA.png){:target="_blank"}


使用此介面，拉出一個按鈕。


![](/assets/d61062833c1a/1*BXXmUWkal7XjluhLcDaSIQ.png){:target="_blank"}


「Save and Close」後可調整、移動按鈕；點擊右上角「…」選擇「Assign script」


![](/assets/d61062833c1a/1*nx2qjDTUKeyorO0W9nOxKA.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*eZpg-qejhpuPgUY7KDg00Q.png){:target="_blank"}


若出現 「Authorization Required」則點選「Continue」完成驗證


![](/assets/d61062833c1a/1*hIgRtqKEFs0tsXDxfNTaOg.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*QUkmTD1WlEzw7cqW97ll6Q.png){:target="_blank"}


點擊「Allow」


![](/assets/d61062833c1a/1*0ZPVBwOR2bB4QPsTGX_yCA.png){:target="_blank"}

> _App Script 執行中會顯示「Running Script」這時候請勿再按，避免重複執行。_



![](/assets/d61062833c1a/1*i12l4Q5Y2N9bM9CzTo6XDg.png){:target="_blank"}

> _顯示執行成功後，才能再次執行。_



![](/assets/d61062833c1a/1*NbOfqAwIYSUAtJ32hSEOCQ.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*LCvfyjnvk3yCaoFnsvVhHg.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*AgGLiLsyvenK-LRWI9rlKg.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*DUcwdLTKt33Fa-jNlW8MkA.png){:target="_blank"}



![](/assets/d61062833c1a/1*v8Z-5vEM043F82TMiZk2lw.png){:target="_blank"}


選擇未填寫訊息想要傳到的 Channel。


![](/assets/d61062833c1a/1*SRciom_ygU0JDKK9ATY1FQ.png){:target="_blank"}


記下最上方的「Webhook URL」


![](/assets/d61062833c1a/1*kp1QDIEwzQtmfzUwZIDTSg.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*6vD5h6VQhYMRTpiT5ncfMQ.png){:target="_blank"}



![](/assets/d61062833c1a/1*gwgJNkj3D4itq-xTGNctDw.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*QfgJL_Xb9JhgQnPGjU2CXg.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*38It1hdMGq-Lr6hlPIcsWQ.png){:target="_blank"}


3\. 選擇「 **From scratch** 」


![](/assets/d61062833c1a/1*-6FB9vEkju_NszxRrb9LKA.png){:target="_blank"}


4\. 輸入「 **App Name** 」跟 你想要加入的 Workspace


![](/assets/d61062833c1a/1*8OPXRdVPW5xHpe1blQDh6w.png){:target="_blank"}


5\. 建立成功後，在左邊選單選擇「OAuth & Permissions」設定頁


![](/assets/d61062833c1a/1*ougV73wzEMnCZ1C3rtx8xg.png){:target="_blank"}


6\. 往下滑到 Scopes 區塊


![](/assets/d61062833c1a/1*SprZwCDHq0gtdlN7O2sc-A.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*iCmyMNlLwjhR9qsk-aTfxA.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*JK0omZIhk1fmP1TOkE2dpg.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*rkw-79xbgd3Nn99fDnLWDQ.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*7EF6ghe032Pp832_61Ui0w.png){:target="_blank"}


點擊要查看 UID 的對象，點擊「View full profile」


![](/assets/d61062833c1a/1*uKOp7Xe7AQ4ODKR2t8iDMw.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*iECjTdwjrRgMswu9MQOMFA.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*A6Yc9RKCHLEnCLEe591sTw.png){:target="_blank"}



![](/assets/d61062833c1a/1*cPJ4JR5wVTZOSmuz635Nyg.png){:target="_blank"}
...
![](/assets/d61062833c1a/1*hxyMW4y03udmyW0QXEuAFQ.png){:target="_blank"}
