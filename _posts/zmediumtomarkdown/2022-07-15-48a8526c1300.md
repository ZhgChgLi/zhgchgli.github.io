...
之前的做法是「 [Xcode 直接使用 Swift 撰寫 Shell Script！](https://medium.com/zrealm-ios-dev/xcode-%E7%9B%B4%E6%8E%A5%E4%BD%BF%E7%94%A8-swift-%E6%92%B0%E5%AF%AB-run-script-41c49a75a743){:target="_blank"} 」參考 [Localize 🏁](https://github.com/freshOS/Localize){:target="_blank"} 工具使用 Swift 開發 Command Line Tool 從外部做多語系檔案檢查，再把腳本放到 Build Phases Run Script 中，在 Build Time 執行檢查。
...
沒有什麼特別的解法，只能自己寫一個 Command Line Tools，可參考 [上一篇文章](https://medium.com/zrealm-ios-dev/xcode-%E7%9B%B4%E6%8E%A5%E4%BD%BF%E7%94%A8-swift-%E6%92%B0%E5%AF%AB-run-script-41c49a75a743){:target="_blank"} 中使用 Swift 掃描專案目錄、Parse 出 NSLocalizedString 的 Regex 撰寫一個小工具去轉換。
...
這個解決方案無法達成，還是需使用原本 [用 Swift 寫的 Command Line Tool 來達成](https://medium.com/zrealm-ios-dev/xcode-%E7%9B%B4%E6%8E%A5%E4%BD%BF%E7%94%A8-swift-%E6%92%B0%E5%AF%AB-run-script-41c49a75a743){:target="_blank"} ，不過 Format 部分可以在 git pre\-commit 做就好；沒有 diff 調整就不做，避免每次 build 都要跑一次：
```shell
#!/bin/sh
...
如同之前「 [2021 Pinkoi Tech Career Talk — 高效率工程團隊大解密](https://medium.com/pinkoi-engineering/2021-pinkoi-tech-career-talk-%E9%AB%98%E6%95%88%E7%8E%87%E5%B7%A5%E7%A8%8B%E5%9C%98%E9%9A%8A%E5%A4%A7%E8%A7%A3%E5%AF%86-11f6c8568154){:target="_blank"} 」的演講內容，在大團隊中多語系工作可以透過第三方服務拆開，多語系工作的依賴關係。
