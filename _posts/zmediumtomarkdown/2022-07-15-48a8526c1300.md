...
![Photo by Mick Haupt](/assets/48a8526c1300/1*G2UsVr02o122GxI2o1WbQQ.jpeg "Photo by Mick Haupt"){:target="_blank"}
...
[![GitHub \- SwiftGen/SwiftGen: The Swift code generator for your assets, storyboards…
SwiftGen is a tool to automatically generate Swift code for resources of your projects \(like images, localised strings…github\.com](https://repository-images.githubusercontent.com/39166950/1826ed00-d6cf-11ea-9736-34829910d1e6 "GitHub \- SwiftGen/SwiftGen: The Swift code generator for your assets, storyboards…
SwiftGen is a tool to automatically generate Swift code for resources of your projects \(like images, localised strings…github\.com"){:target="_blank"}](https://github.com/SwiftGen/SwiftGen)
...
```
/L10NTester/Pods/SwiftGen/bin/swiftGen config init
```
...
strings:
  - inputs:
      - "LocalizableDemo/Supporting Files/zh-Hant.lproj/Localizable.strings"
    outputs:
      templateName: structured-swift5
      output: "LocalizableDemo/Supporting Files/SwiftGen-L10n.swift"
      params:
        enumName: "L10n"
```
...
![flat v\.s\. structured](/assets/48a8526c1300/1*J5ZOMW6BC-fDqSlh-My2Pg.jpeg "flat v\.s\. structured")
...
strings:
  - inputs:
      - "Supporting Files/zh-Hant.lproj/Localizable.strings"
    outputs:
      templatePath: "path/to/flat-swift5-objc.stencil"
      output: "Supporting Files/SwiftGen-L10n.swift"
      params:
        enumName: "L10n"
```
...
```
/L10NTester/Pods/SwiftGen/bin/swiftGen
```
...
- 記得將 Test Target 的 [STRINGS_FILE_OUTPUT_ENCODING](https://developer.apple.com/forums/thread/71779){:target="_blank"} 
...
[![GitHub \- zhgchgli0718/L10NTests
You can't perform that action at this time\. You signed in with another tab or window\. You signed out in another tab or…github\.com](https://opengraph.githubassets.com/5e3a8099a333f9bf5a74339f82426afdd235c5a6ca6b9910196a4b961eb2b31a/zhgchgli0718/L10NTests "GitHub \- zhgchgli0718/L10NTests
You can't perform that action at this time\. You signed in with another tab or window\. You signed out in another tab or…github\.com"){:target="_blank"}](https://github.com/zhgchgli0718/L10NTests)
...
![Wei Cao, iOS Developer @ Pinkoi](/assets/48a8526c1300/1*CCGSKp2-BvATpDAuRiRuRQ.jpeg "Wei Cao, iOS Developer @ Pinkoi"){:target="_blank"}
...
| **[View original post on Medium](https://medium.com/zrealm-ios-dev/ios-%E7%82%BA%E5%A4%9A%E8%AA%9E%E7%B3%BB%E5%AD%97%E4%B8%B2%E8%B2%B7%E4%BB%BD%E4%BF%9D%E9%9A%AA%E5%90%A7-48a8526c1300) - Converted by [ZhgChgLi](https://zhgchg.li)/[ZMediumToMarkdown](https://github.com/ZhgChgLi/ZMediumToMarkdown)** |
