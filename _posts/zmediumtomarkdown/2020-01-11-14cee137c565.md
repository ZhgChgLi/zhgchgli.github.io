...
\ [_*_](https://stackoverflow.com/questions/29558622/pan-gesture-why-need-settranslation-to-zero){:target="_blank"}  [_關於 sender\.setTranslation\(\.zero, in:interactiveView\) 原因的補充點我&lt;_](https://stackoverflow.com/questions/29558622/pan-gesture-why-need-settranslation-to-zero){:target="_blank"}
...
> **_值得一提的是…_** 
_iOS ≥ 13，如果遇到 View 內容有 UITextView，在做下拉關閉動畫時，動畫當中 UITextView 的文字內容會一片空白；造成體驗會閃一下\ [(](https://twitter.com/zhgchgli/status/1207851671553892352){:target="_blank"}  [影片範例\)](https://twitter.com/zhgchgli/status/1207851671553892352){:target="_blank"} …_ 
...
\ [_*_](https://juejin.im/entry/5795809dd342d30059ed5c60){:target="_blank"}  [_詳細方法點我&lt;_](https://juejin.im/entry/5795809dd342d30059ed5c60){:target="_blank"}
