...
last_modified_at: 2023-02-26T09:04:03.107+0000
...
![](/assets/a5643de271e4/1*599SdmCetu1J2Aoc-rEaww.png)
...
```
### Know\-how
- 目前暫時不支援圖片解析，另外如果直接使用 NSTextAttacment 嵌入圖片到 NSAttributedString 中會導致 OOM \(不會 reuse\)，細節可參考我 [之前的文章](../e37d66ea1146/)
...
_Converted [Medium Post](https://medium.com/zrealm-ios-dev/zmarkupparser-html-string-%E8%BD%89%E6%8F%9B-nsattributedstring-%E5%B7%A5%E5%85%B7-a5643de271e4){:target="_blank"} by [ZMediumToMarkdown](https://github.com/ZhgChgLi/ZMediumToMarkdown){:target="_blank"}._
