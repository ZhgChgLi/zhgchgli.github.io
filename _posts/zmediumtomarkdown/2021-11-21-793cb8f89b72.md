...
last_modified_at: 2021-11-21T14:47:10.076Z
...
![](/assets/793cb8f89b72/1*yPSS8J7o-jowQ6NRYArzjQ.png){:target="_blank"}
...
![](/assets/793cb8f89b72/1*nvZXYgkj_8AdqHdR_yTCWg.png){:target="_blank"}
...
![[API Dimensions & Metrics](https://developers.google.com/analytics/devguides/reporting/data/v1/api-schema?hl=en){:target="_blank"}{:target="_blank"}](/assets/793cb8f89b72/1*4BVf-FMVcY1UbVuLwfKOQg.png)

[API Dimensions & Metrics](https://developers.google.com/analytics/devguides/reporting/data/v1/api-schema?hl=en)
...
![](/assets/793cb8f89b72/1*qsCMVfWIAzWdZ78LBj8n2A.jpeg){:target="_blank"}
...
![](/assets/793cb8f89b72/1*hFJ9KYfecVNmdi4VfDAyIw.png){:target="_blank"}

- Start Date、EndDate：可直接輸入日期或用特殊變數表示日期 \( `ysterday` , `today` , `30daysAgo` , `7daysAgo` \)



![](/assets/793cb8f89b72/1*GEa3BNpUAqoPD07gE-N21A.png){:target="_blank"}

- metrics：增加 `crashFreeUsersRate`



![](/assets/793cb8f89b72/1*WygzFvmOLp2kUQC3H_lh2g.png){:target="_blank"}

- dimensions：增加 `platform` \(設備類型 iOS/Android/Desktop\.\.\.\)



![](/assets/793cb8f89b72/1*RE8SIIVx4PUkqnHQVsJcTg.png){:target="_blank"}
...
![](/assets/793cb8f89b72/1*1NJNUZscuU2XIicgRPGFYg.png){:target="_blank"}
...
![](/assets/793cb8f89b72/1*kMByIU9_6mxg8-F4BbwLuw.png){:target="_blank"}


假設我們的 Google Sheet 如上圖。


![](/assets/793cb8f89b72/1*pnJ7gmjDefB9OLl0NgceLA.png){:target="_blank"}
...
![](/assets/793cb8f89b72/1*81_RPPZgBDvW4XplOHGmVg.png){:target="_blank"}


進來後可以先點上方未命名專案名稱，給個專案名稱。


![](/assets/793cb8f89b72/1*C4qUfJr2UHAzbcksP2zYWA.jpeg){:target="_blank"}


在左方的「Services」點「\+」加上「Google Analytics Data API」。


![](/assets/793cb8f89b72/1*FfWGQiV2IpOAsQB6TN887g.png){:target="_blank"}
...
![](/assets/793cb8f89b72/1*_ypOYamULlL_dcDsph4KiQ.jpeg){:target="_blank"}
...
![](/assets/793cb8f89b72/1*5lCtwwr3kZlBEEoW_D33gw.jpeg){:target="_blank"}


將以上程式碼貼到 Google Apps Script 右方程式碼區塊＆上方執行方法選擇「execute」function 後可以點擊 Debug 測試看看是否能正常取得資料：


![](/assets/793cb8f89b72/1*patatPx4XveqzXfkmetZyA.jpeg){:target="_blank"}


第一次執行會出現要求授權視窗：


![](/assets/793cb8f89b72/1*6997jA1kINxLfhcxx2NcDQ.png){:target="_blank"}


按照步驟完成帳號授權即可。


![](/assets/793cb8f89b72/1*_UjZ9Gx3TEvuxZd4ypaYsw.png){:target="_blank"}
...
![](/assets/793cb8f89b72/1*tO7f0t5if6Db_eiv5BLOUQ.png){:target="_blank"}
...
![](/assets/793cb8f89b72/1*MGO4FhC_8N8ul9dXZRYaMg.jpeg){:target="_blank"}


選擇左方時鐘按鈕 \-> 右下方「\+ Add Trigger」。


![](/assets/793cb8f89b72/1*EArxafXakAcfuPWcr1wtIg.png){:target="_blank"}
...
![](/assets/793cb8f89b72/1*0VfbK9BIt13LsIEeHGc2LQ.jpeg){:target="_blank"}
