...
last_modified_at: 2021-11-21T14:52:42.902Z
...
![Photo by [Paweł Czerwiński](https://unsplash.com/@pawel_czerwinski?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText){:target="_blank"}{:target="_blank"}](/assets/70a1409b149a/1*dFvxm6SynzYOmMEUALKJaA.jpeg)
...
![完成通知！](/assets/70a1409b149a/1*14yKaOt2YNSMILOD_EoXLg.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*jb-FAN5h1oFVFFvu1bpYgw.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*DBi9YVmfoaPH9WSCoPXycA.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*q2wbmQ3MJ6nYfjFSBHL9fw.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*dIp1k-0u-BhJ7iTs0wEIuA.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*eVF56j1oOgXeZYbkD1m22g.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*XVYHKZXoHT-2qkbwRcK5Qw.png){:target="_blank"}

- 選擇「Create a Messaging API channel」



![](/assets/70a1409b149a/1*8l_awW31J7FlYh5EvacSmA.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*JCmFicC5gXVJ6j3Vgi7CPQ.png){:target="_blank"}

- 建立好之後，選擇「Messaging API」Tab，掃描 QRCode 將機器人加入好友。



![](/assets/70a1409b149a/1*dOF0mHXz6z7be13zjIubTA.png){:target="_blank"}

- 繼續往下滾找到「Channel access token」區塊，點擊「Issue」產生 token。



![](/assets/70a1409b149a/1*eNiyLol6nokoOKsrGp21kw.png){:target="_blank"}

- 複製下來產生出來的 Token，我們有這組 Token 就能發訊息給使用者。



![](/assets/70a1409b149a/1*LDr_vT4urUL73Z_p--yiKA.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*7I7FMpQ-Gv5MKD0SWkIE0A.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*pWDK9AQKpbDpgDltFfS9-g.png){:target="_blank"}

- 上方選擇「建立函式」



![](/assets/70a1409b149a/1*ED2WPgfaSHEth3zWUJn05w.png){:target="_blank"}

- 輸入基本資訊



![](/assets/70a1409b149a/1*oetW_iIU9XywDbLZIa8tJQ.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*qJC7rcjOnSeKWa8NiYxbpQ.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*zCK21j82QwsHD1nARuZkBw.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*jl5joofEWPMLR3JuP988BQ.png){:target="_blank"}

- 程式碼部分 OK 之後，切換到「requirements\.txt」輸入有用到的套件依賴：



![](/assets/70a1409b149a/1*2MTOKWDWlXbfjYP1qgp7Sw.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*eQvtozhghRLQhxUgE9fMhw.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*yv1wMHELWSrXiEvE44c9Sw.png){:target="_blank"}


如果出現 `500 Internal Server Error` 則代表程式有錯，可點擊名稱進入查看「紀錄」，在其中找到原因：


![](/assets/70a1409b149a/1*DeiRZT3wC1Z7Jv4WIRaM_Q.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*KqwYbY826bdVaSIlHUnpbA.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*AAXUcDRZNnRAqIFj02RnyA.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*0DO31noJ4a3xweb1annbSQ.png){:target="_blank"}


在左方選單列找到「 **Cloud Firestore** 」\->「 **新增集合** 」


![](/assets/70a1409b149a/1*7c9sA8ZbxE6uGh6f-nfiVA.png){:target="_blank"}


輸入集合 ID。


![](/assets/70a1409b149a/1*wcp94_25maNL9EoFJTOndA.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*JeB9m4BWzfRCZSofHq2tLg.png){:target="_blank"}


下方「新增金鑰」\->「建立新的金鑰」


![](/assets/70a1409b149a/1*xi9nQUy48-QlFI4BEdIMew.png){:target="_blank"}


選擇「JSON」下載檔案。


![](/assets/70a1409b149a/1*bsphvdEHgg0XDnHAHMXJvg.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*d67oTblFFKaBHkGC77Mapw.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*5tNybi2HssmWoyJDQyPSJQ.png){:target="_blank"}

- 輸入工作基本資料



![](/assets/70a1409b149a/1*yqkJnt9PVYEllOpDtK1RmQ.png){:target="_blank"}


**執行頻率：** 同 crontab 輸入方式，如果你對 crontab 語法不熟，可以直接使用 [**crontab\.guru 這個神器網站**](https://crontab.guru/#15_1_*_*_*){:target="_blank"} ：


![](/assets/70a1409b149a/1*xnZBlcsMrQVJc6ewJIfAxA.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*H_nsZNQ16iIKwThQpGJDmA.png){:target="_blank"}



![](/assets/70a1409b149a/1*X6pL0J4hGL_KodhsppvsJg.png){:target="_blank"}

- 可查看執行結果、上次執行日期



![](/assets/70a1409b149a/1*pUqTo-NM1z-srXbq1BM4rA.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*cfuKJxNoW4tvCEhqdC7oIQ.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*2431d2F1BNtEJUg845uDQg.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*2t1boe9DQX1NBgGyYTrVnA.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*b9cvGpPqjKRFHa-45Yuzdw.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*OvWXsZbwnM8sNfvdtDAIOA.png){:target="_blank"}


如果剛剛 Cloud Functions 選擇的是 US\-WEST1、US\-CENTRAL1 或 US\-EAST1 這三個地區則可享有免費使用額度：


![](/assets/70a1409b149a/1*arevMQGpsIumGlw_PE-hQQ.png){:target="_blank"}


我是選擇 US\-CENTRAL1 沒錯，可以看到第一個 Cloud Storage 實體的地區是 US\-CENTRAL1 沒錯，但第二個是寫 **美國多個地區** ； **我自已估計這項是會被收費的** 。


![](/assets/70a1409b149a/1*kuX9HlPTfMxbEg-sa3rJOQ.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*r0T8gZsaWroxhWxIxKwRWQ.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*GtT4Sj9Q19O_QxWTWgM5UA.png){:target="_blank"}

- 點擊上方「 **設定預算** 」



![](/assets/70a1409b149a/1*ytmGKw4sy6b-U3XAeI_geQ.png){:target="_blank"}

- 輸入自訂名稱



![](/assets/70a1409b149a/1*_qgQMB_WsCuoxtJ4vA6xgw.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*y6fIpzReQxZZRsVpZIk-tw.png){:target="_blank"}
...
![](/assets/70a1409b149a/1*y4B62yjPWAy1pBQhZmiySQ.png){:target="_blank"}


**勾選** 「 **透過電子郵件將快訊傳送給帳單管理員和使用者** 」，這樣當條件處發時就能第一時間收到通知。


![](/assets/70a1409b149a/1*PTQDG_Uffa8fvHxaeYCnrQ.png){:target="_blank"}


點擊「完成」送出儲存。


![](/assets/70a1409b149a/1*QWH-bIlQAC7hhc4SVQOI5g.png){:target="_blank"}



![](/assets/70a1409b149a/1*-BAHV1lovaYgblnCCubmSQ.png){:target="_blank"}
...
_Converted [Medium Post](https://medium.com/zrealm-ios-dev/%E4%BD%BF%E7%94%A8-python-google-cloud-platform-line-bot-%E8%87%AA%E5%8B%95%E5%9F%B7%E8%A1%8C%E4%BE%8B%E8%A1%8C%E7%91%A3%E4%BA%8B-70a1409b149a) by [ZMediumToMarkdown](https://github.com/ZhgChgLi/ZMediumToMarkdown)._
