...
last_modified_at: 2021-02-24T01:26:53.094Z
...
![](/assets/cb6eba52a342/1*8juoKO7BZiT3PQjqufWcrA.jpeg){:target="_blank"}
...
![](/assets/cb6eba52a342/1*dd2kRizi6v-AIXcMWourow.png){:target="_blank"}
...
![**Step 1\.** Xcode \-> File \-> New \-> Target](/assets/cb6eba52a342/1*ZjPVTxLR6ywAdk70Y7_J7A.png){:target="_blank"}

**Step 1\.** Xcode \-> File \-> New \-> Target


![**Step 2\.** iOS \-> Notification Service Extension \-> Next](/assets/cb6eba52a342/1*2KRusR8MJUim7UH1CmS7pw.png){:target="_blank"}

**Step 2\.** iOS \-> Notification Service Extension \-> Next


![**Step 3\.** 輸入Product Name \-> Finish](/assets/cb6eba52a342/1*sAuzxJPpohTGp-KV13yupg.png){:target="_blank"}

**Step 3\.** 輸入Product Name \-> Finish


![**Step 4\.** 點選 Activate](/assets/cb6eba52a342/1*3DF_fMQLSrGxTbmLY6CJAg.png){:target="_blank"}
...
![找到Product Name/NotificationService\.swift檔](/assets/cb6eba52a342/1*UsCd2btDPK6GWKrYEA9LbQ.png){:target="_blank"}
...
![[結婚吧APP](https://itunes.apple.com/tw/app/%E7%B5%90%E5%A9%9A%E5%90%A7-%E4%B8%8D%E6%89%BE%E6%9C%80%E8%B2%B4-%E5%8F%AA%E6%89%BE%E6%9C%80%E5%B0%8D/id1356057329?ls=1&mt=8){:target="_blank"}{:target="_blank"}](/assets/cb6eba52a342/1*SepeUiS7CN7xmGFxariPjA.png)
