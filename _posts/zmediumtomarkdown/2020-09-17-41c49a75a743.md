...
**安裝方法：**
1. [下載工具的 Swift Script 檔案](https://github.com/freshOS/Localize/blob/master/Localize.swift)
...
**安裝方法：**
1. [下載工具的 Swift Script 檔案](https://github.com/freshOS/AssetChecker/blob/master/Classes/main.swift)
