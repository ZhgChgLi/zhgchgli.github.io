...
last_modified_at: 2023-08-28T14:53:27.813+0000
...
[![](https://opengraph.githubassets.com/2c3b8bc3fc216c74a938fba39c30ad1dc7d13f714343c2c060d17169f8246c74/pointfreeco/swift-snapshot-testing)](https://github.com/pointfreeco/swift-snapshot-testing){:target="_blank"}
...
> 對重大功能的重構也能先建立重構前的流程測試，重構後重新驗。 





> 確保重構前後功能如預期，重構中再補上 Unit Testing、Integration Testing 增加穩定性，打破雞生蛋蛋生雞的問題。 
...
[![](https://opengraph.githubassets.com/9854384a7a7731744fa9545a9ef7d3b82d398bf400423c4c2917d62ffaa10176/mobile-dev-inc/maestro)](https://github.com/mobile-dev-inc/maestro){:target="_blank"}
...
- `network_restricted` record 為 `False` 時，本地沒資料時該如何處理；為 `True` 時會去打目標 Server 拿資料；False 時則會直接回應 `404` 。
