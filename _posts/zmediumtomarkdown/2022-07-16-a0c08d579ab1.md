...
author: ZhgChgLi
date: 2022-07-16T16:00:47.481Z
last_modified_at: 2022-07-17T08:11:02.041Z
...
![[zhgchg\.li](http://zhgchg.li){:target="_blank"}{:target="_blank"}](/assets/a0c08d579ab1/1*XsLBwUYruBOgUy3snkhoxw.png)
...
![[zhgchg\.li](http://zhgchg.li){:target="_blank"}{:target="_blank"}](/assets/a0c08d579ab1/1*8yvr8SHvKxScqbu_3Lv7HA.gif)
...
![](/assets/a0c08d579ab1/1*uVcwZLxSUZymjxILlXyNcw.png){:target="_blank"}
...
![](/assets/a0c08d579ab1/1*AJXLDusJQ7XJQjWHQOqWGA.png){:target="_blank"}


在 Terminal 輸入 `ruby \-v` 查看當前 Ruby、 `gem \-v` 查看當前 RubyGems 狀況：


![](/assets/a0c08d579ab1/1*ANyW3uysaKSiySTDGi28gw.png){:target="_blank"}
...
![](/assets/a0c08d579ab1/1*XRaln4SJiK-la32HhSYPug.png){:target="_blank"}
...
![](/assets/a0c08d579ab1/1*cQUPBm6tzyceXV-iwY5rzw.png){:target="_blank"}
...
![](/assets/a0c08d579ab1/1*4ebE2NABGtRbKvc75e6aLA.png){:target="_blank"}


執行 `bundle lock — add\-platform x86\_64\-linux` 鎖定版本


![](/assets/a0c08d579ab1/1*Xvp8WBvKYU59fBVlEne14w.png){:target="_blank"}

#### 修改網站設定

打開 \ `_`  `config\.yml` 設定檔案進行設定：
```yaml
...
![](/assets/a0c08d579ab1/1*f9xi6k6NCjesF0YtgjvogQ.png){:target="_blank"}


複製其中的網址 `http://127\.0\.0\.1:4000/` 貼到瀏覽器打開


![](/assets/a0c08d579ab1/1*BSUbXFi082ZkHil2cWV2BQ.png){:target="_blank"}
...
![](/assets/a0c08d579ab1/1*Rf8A-Y36J1oy6rwG1Crt8w.png){:target="_blank"}
...
![](/assets/a0c08d579ab1/1*g9n4qBgEWb_ErOOwqrUC6Q.jpeg){:target="_blank"}
...
### 建立/編輯文章
- 我們可以先把 \ `_`  `posts/` 目錄下的範例文章檔案全數刪除。


使用 [Visual Code](https://code.visualstudio.com/){:target="_blank"}{:target="_blank"} \(免費\) 或 [Typora](https://typora.io/){:target="_blank"} \(付費\) 建立 Markdown 檔案，這邊以 [Visual Code](https://code.visualstudio.com/) 為例：


![](/assets/a0c08d579ab1/1*5xgNYYYQXHylU6GV_akGfQ.png){:target="_blank"}
...
我是 **ZhgChgLi**
圖片：
![](/assets/post_images/DSC_2297.jpg){:target="_blank"}
```

**成果：**


![](/assets/a0c08d579ab1/1*44ZMj3cemJGr-l0OripI6Q.png){:target="_blank"}

> ⚠️ 文章調整不需要重新啟動網站，檔案變更後會直接渲染顯示，如果過一陣子都沒出現修改內容，可能是文章內容格式有誤導致渲染失敗，可回到 Terminal 查看原因。



![](/assets/a0c08d579ab1/1*FRx_7B8vbRqOq345Ts682A.png){:target="_blank"}
...
[![[**GitHub \- ZhgChgLi/ZMediumToMarkdown: ZMediumToMarkdown lets you download Medium post and convert it…**](https://github.com/ZhgChgLi/ZMediumToMarkdown){:target="_blank