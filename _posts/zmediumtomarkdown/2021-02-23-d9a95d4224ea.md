...
![](/assets/d9a95d4224ea/1*Yoz3gwb9HPe2d-ja6Y8W-Q.png){:target="_blank"}

### TL;DR \[2022/07/11\] 此功能又被關閉了


![](/assets/d9a95d4224ea/1*o5LrrPHvIFm42SLffVH_Nw.png){:target="_blank"}
...
![姓李的好處？](/assets/d9a95d4224ea/1*JlTuqsMyGa5fYCnUYEaIOw.png){:target="_blank"}
...
![](/assets/d9a95d4224ea/1*rMdeqUtI_mqhu4E0S9-hrg.png){:target="_blank"}


得到搜尋結果：


![](/assets/d9a95d4224ea/1*onP_MBBew5tEznz0Jlplog.png){:target="_blank"}
...
![](/assets/d9a95d4224ea/1*3R6HAQgpimJ33bax6ywe0g.png){:target="_blank"}


加入購物車後點擊下方「 **Checkout** 」。


![](/assets/d9a95d4224ea/1*Xcm3dGx100WOYUcpgBFT9w.png){:target="_blank"}


進入訂單確認頁：


![](/assets/d9a95d4224ea/1*vfmnXvEaFubrAHHMaRy6hw.png){:target="_blank"}
...
![](/assets/d9a95d4224ea/1*AZ3Evt6kFyzKNYepeVW7cw.png){:target="_blank"}
...
![](/assets/d9a95d4224ea/1*2l-4pmtoyKepXD3nvKxRPw.png){:target="_blank"}


之後就購買成功囉！


![](/assets/d9a95d4224ea/1*NMFFKl7SyCVi3v1ZFZFT1Q.png){:target="_blank"}
...
![](/assets/d9a95d4224ea/1*BHbXLRSqCjCZyf6ynHlvww.png){:target="_blank"}


進入「 **Dashboard** 」後切換到「 **Domain List** 」頁籤，找到剛買的 Domain 點 「 **Manage** 」


![](/assets/d9a95d4224ea/1*xIK5jsLCbnc7jgmuwUyLug.png){:target="_blank"}


進來之後切換到最後一個「 **Advanced DNS** 」頁籤


![](/assets/d9a95d4224ea/1*FsXSsQThWhh_Y93L5zqsFQ.png){:target="_blank"}
...
![](/assets/d9a95d4224ea/1*vjun5sB8zRWjbo_xK_iIWg.png){:target="_blank"}
...
![](/assets/d9a95d4224ea/1*pnD2kJPixXfREUNcmsdFRw.png){:target="_blank"}


輸入你的 Domain 名稱，ex: `www\.example\.com`


![](/assets/d9a95d4224ea/1*W4litf2WcjZ-G8HwLVhLkg.png){:target="_blank"}
...
![](/assets/d9a95d4224ea/1*OW3qjvxYXCzSo6UuPvkAcg.png){:target="_blank"}


點擊下方「 **ADD NEW RECORD** 」按鈕兩次，出現兩筆新增資料框。


![](/assets/d9a95d4224ea/1*NnjyygCAcH2st_7M-Is39A.png){:target="_blank"}
...
![](/assets/d9a95d4224ea/1*PuoZ0zUuFcn6VcyUulZq0A.png){:target="_blank"}
...
![](/assets/d9a95d4224ea/1*j1HD1RdsVFPk5myB5ZSsGA.png){:target="_blank"}


**出現處理中頁面，代表設定完成！**


![](/assets/d9a95d4224ea/1*FJSLUp4TWM2qbjIw8ZIw9g.png){:target="_blank"}
...
![](/assets/d9a95d4224ea/1*KjM-mDxPHipdO0sMEcohHQ.png){:target="_blank"}
...
![](/assets/d9a95d4224ea/1*PZjCUYWW9wvLii3953Y2lQ.png){:target="_blank"}
