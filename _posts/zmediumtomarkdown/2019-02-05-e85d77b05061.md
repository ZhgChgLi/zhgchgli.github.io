...
last_modified_at: 2021-02-24T01:32:21.467Z
...
![[結婚吧 — 最大婚禮籌備App](https://itunes.apple.com/tw/app/%E7%B5%90%E5%A9%9A%E5%90%A7-%E4%B8%8D%E6%89%BE%E6%9C%80%E8%B2%B4-%E5%8F%AA%E6%89%BE%E6%9C%80%E5%B0%8D/id1356057329#?platform=appleWatch){:target="_blank"}{:target="_blank"}](/assets/e85d77b05061/1*aNqsa7aR3Vi3NIIvaUFZLA.png)
...
![File \-> New \-> Target \-> watchOS \-> WatchKit App](/assets/e85d77b05061/1*yxwki7mCbfJbEfsTDM683A.png){:target="_blank"}
...
![](/assets/e85d77b05061/1*WIjSrYl5Hch0mGIjlNbyFQ.png){:target="_blank"}
...
![Scene預設會和Notification Controller Scene擠在一起 \(我會把它拉上面一點分開\)](/assets/e85d77b05061/1*2ibd9b4yaRGxwSpgKMdyUw.png){:target="_blank"}
...
![](/assets/e85d77b05061/1*ZcS9q4gNSBo6MZLp1eITeA.jpeg){:target="_blank"}

#### 元件庫：


![沒有太多複雜的元件，元件功能也都簡單明瞭](/assets/e85d77b05061/1*Armv40CxLqJ1wlbMI_o1oQ.png){:target="_blank"}
...
![Group的參數設置](/assets/e85d77b05061/1*aoHxAFjEGgH3ZLQx9GhH_Q.png){:target="_blank"}
...
![](/assets/e85d77b05061/1*8NfJeD4FsUw-SpAx_VFDCQ.png){:target="_blank"}
...
![](/assets/e85d77b05061/1*oY9kLcnASy9j1WXxV4FGPA.png){:target="_blank"}
...
![](/assets/e85d77b05061/1*bui2UXp9QwBYSYC-mwyK6g.png){:target="_blank"}
...
![](/assets/e85d77b05061/1*2bsyQ9Szfptugtg_KKxcgg.png){:target="_blank"}
...
![](/assets/e85d77b05061/1*ez1NpEq3fgAMEqNjwTvWdw.png){:target="_blank"}
...
![Layout設定Overlap，裡面子View要做未讀訊息Label的圖層堆疊顯示](/assets/e85d77b05061/1*axrBV1EHrPtOHvTnLtB79w.png){:target="_blank"}

Layout設定Overlap，裡面子View要做未讀訊息Label的圖層堆疊顯示


![設固定長寬40的正方形](/assets/e85d77b05061/1*Ti346bLg8AM2FInO6PNwLw.png){:target="_blank"}
...
![Layout設定Vertical，裡面子View要做上下兩個顯示](/assets/e85d77b05061/1*5aq_TTFEp3kq6RusiTkYcw.png){:target="_blank"}

Layout設定Vertical，裡面子View要做上下兩個顯示


![寬度設定參照外層，比例100%，扣掉左邊綠色部分40](/assets/e85d77b05061/1*aXH2d1kDRLNl4XsizV9P_g.png){:target="_blank"}
...
![](/assets/e85d77b05061/1*NR2vAZ3mqPMjCLqBCJ6ZxQ.png){:target="_blank"}
...
![選定Row\->Identifier\->輸入自訂名稱](/assets/e85d77b05061/1*VTCVIJRAG-sGdBLjC26TKg.png){:target="_blank"}
...
![這邊我再拉一個Row用於呈現無資料時的提示](/assets/e85d77b05061/1*kQOKjxqmtI7M8BwYQ0yY0A.png){:target="_blank"}
...
![](/assets/e85d77b05061/1*RiCY7mH4_MyocNPN1GDuvA.png){:target="_blank"}
...
![](/assets/e85d77b05061/1*-AnyG0_PLubAX7f-579BMw.png){:target="_blank"}
...
![首先為Interface Controller設定Identifier](/assets/e85d77b05061/1*1KovG3qshPRsCgUXkbDYFw.png){:target="_blank"}
...
![push方式可左上返回](/assets/e85d77b05061/1*snXj8xFP0MtF3_sVWK1xUw.png){:target="_blank"}
...
![頁籤顯示方式可以左右切換頁面](/assets/e85d77b05061/1*teUOM4Wql2hexR51g7v1lQ.png){:target="_blank"}
...
![](/assets/e85d77b05061/1*eVT-62WCBy1ZZC90abJPqA.png){:target="_blank"}
...
![如要修改/啟用/停用 PushNotificationPayload\.apns，請選擇Target後Edit Scheme](/assets/e85d77b05061/1*1nlJOqwVqpMP6WtwdRcLPA.png){:target="_blank"}
...
![會同手機推播，這邊手機端iOS有實做UNUserNotificationCenter\.setNotificationCategories在通知下方增加按鈕；Apple Watch預設亦然會出現](/assets/e85d77b05061/1*uQN8Km08rio4tylAw48LyQ.jpeg){:target="_blank"}
...
![可在Interface\.storyboard中的Static Notification Interface Controller Scene設定推播處理方式](/assets/e85d77b05061/1*PlYKw5M3XBVDtjOa2tklgg.png){:target="_blank"}
...
![我的自訂推播呈現設計](/assets/e85d77b05061/1*RYSdWHxgmZX6Ht6m11Qpig.png){:target="_blank"}
...
![左使用interactive，右使用self\.notificationActions](/assets/e85d77b05061/1*_1Crgx61kE6F509Jd2qxPQ.jpeg){:target="_blank"}
...
![在元件庫中拉入Menu，再拉入選單項目Menu Item，再拉IBAction到程式控制](/assets/e85d77b05061/1*qHUly8lLEa5L7FSPJCrbcw.png){:target="_blank"}
...
![](/assets/e85d77b05061/1*9aj7kUPsv9d8XUvgCpqfOg.png){:target="_blank"}
...
![](/assets/e85d77b05061/1*CWr9RIb55Sn-FoMrTmc7sQ.png){:target="_blank"}
...
![Apple Watch App Target 部署到手錶真的有夠慢 — [Narcos](https://www.netflix.com/tw/title/80025172){:target="_blank"}{:target="_blank"}](/assets/e85d77b05061/1*-J9qZ846ZysJEhMTSZeE3w.jpeg)
...
_Converted [Medium Post](https://medium.com/zrealm-ios-dev/%E5%8B%95%E6%89%8B%E5%81%9A%E4%B8%80%E6%94%AF-apple-watch-app-%E5%90%A7-e85d77b05061) by [ZMediumToMarkdown](https://github.com/ZhgChgLi/ZMediumToMarkdown)._
