...
last_modified_at: 2024-09-06T05:59:10.794+0000
...
> _這篇的場景是抽象 UITableView x CellViewObject，是一對多的關係，Visitor Pattern 的核心是 雙重派發（Double Dispatch）多對多關係， **因此此場景我後來想了一下可能並不一一定要使用 Visitor Pattern。**_ 
