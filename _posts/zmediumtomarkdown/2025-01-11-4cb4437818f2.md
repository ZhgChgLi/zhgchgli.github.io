...
last_modified_at: 2025-01-11T11:32:41.727+0000
...
![[Demo App Form](https://script.google.com/macros/s/AKfycbw8SuK7lLLMdY86y3jxMJyzXqa5tdxJryRnteOnNi-lK--j6CmKYXj7UuU58DiS0NSVvA/exec){:target="_blank"}](/assets/4cb4437818f2/1*xlRuXyKS5vJigUKUoy0bEA.png)
...
function doGet(e) {
  ...
  htmlTemplate.pullRequests = []; // 下一步再串接 Github...
