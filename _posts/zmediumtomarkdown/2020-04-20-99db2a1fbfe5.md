...
last_modified_at: 2021-02-24T01:39:50.697Z
...
![photo by [picjumbo\.com](https://www.pexels.com/zh-tw/@picjumbo-com-55570?utm_content=attributionCopyText&utm_medium=referral&utm_source=pexels){:target="_blank"}{:target="_blank"}](/assets/99db2a1fbfe5/1*qZeTn0r2u_MKJXubV17XvQ.jpeg)
...
![](/assets/99db2a1fbfe5/1*6ftbgAxlvmdv-35of98ohA.jpeg){:target="_blank"}
...
![](/assets/99db2a1fbfe5/1*7p0ehajJqdqb4-_w9uHt7g.jpeg){:target="_blank"}
...
![Raspberry Pi 3B \(special thanks to [Lu Xun Huang](https://medium.com/u/b32ce1b681f8){:target="_blank"}{:target="_blank"} \)](/assets/99db2a1fbfe5/1*go-wGMdV1VVbJ3c00rh0_w.jpeg)
...
![第一項選擇剛下載的樹莓派作業系統「xxxx\.img」、第二項選擇你的記憶卡裝置，然後點擊「Flash\!」開始燒錄！](/assets/99db2a1fbfe5/1*3YcqdSf9z5RNqD6KJkd4Nw.png){:target="_blank"}

第一項選擇剛下載的樹莓派作業系統「xxxx\.img」、第二項選擇你的記憶卡裝置，然後點擊「Flash\!」開始燒錄！


![此時會跳出要你輸入 **MacOS 的密碼** ，輸入後按「Ok」繼續。](/assets/99db2a1fbfe5/1*o9XE1WYrBpeKSE31Ob9gcQ.png){:target="_blank"}

此時會跳出要你輸入 **MacOS 的密碼** ，輸入後按「Ok」繼續。


![燒錄中…請稍候…\.](/assets/99db2a1fbfe5/1*Z9oOKg9KPMpj3TZfvOvYeA.png){:target="_blank"}

燒錄中…請稍候…\.


![驗證中…請稍候…\.](/assets/99db2a1fbfe5/1*2G930lN4q4MVs4LCeE5y1w.png){:target="_blank"}

驗證中…請稍候…\.


![燒錄成功！](/assets/99db2a1fbfe5/1*CEB4bAMTQshY3u7MEC3q5w.png){:target="_blank"}
...
![ssh](/assets/99db2a1fbfe5/1*aGJHebPl5MMf4iy0Um9bjg.png){:target="_blank"}
...
![](/assets/99db2a1fbfe5/1*6HZ0Fqp6cgpn1F3_4UwM0Q.png){:target="_blank"}
...
![**連線成功！**](/assets/99db2a1fbfe5/1*okEJeW9xZN8XFfRYJyp4Xg.png){:target="_blank"}
...
![](/assets/99db2a1fbfe5/1*QfhJwWvicEGfk_8PFLy7pA.png){:target="_blank"}
...
移動到文件最底部，加上一行「 `export LC\_ALL=C` 」
...
![](/assets/99db2a1fbfe5/1*Z3E5QTXErDmmNVRd5QYo8g.gif){:target="_blank"}
...
![沒錯誤訊息即可！](/assets/99db2a1fbfe5/1*u3xgdplBB-7DyvSpAJU4dA.png){:target="_blank"}
...
![](/assets/99db2a1fbfe5/1*L5C-2SCUV-Cf4yCDwYy8eg.png){:target="_blank"}
...
![](/assets/99db2a1fbfe5/1*_Hwvt6tkKhsNE9TDkOaYAA.png){:target="_blank"}


**進入設定：**


![選擇第五項「 **Interfacing Options** 」](/assets/99db2a1fbfe5/1*_EMj-6phsY5PjrPjqeavDg.png){:target="_blank"}

選擇第五項「 **Interfacing Options** 」


![選擇第三項「 **P3 VNC** 」](/assets/99db2a1fbfe5/1*CAHN3qczUpajbGGU9gaD9g.png){:target="_blank"}

選擇第三項「 **P3 VNC** 」


![使用 「 **←** 」選擇「 **Yes** 」打開](/assets/99db2a1fbfe5/1*wq4S5b33MpAJUiqt9z1EMg.png){:target="_blank"}

使用 「 **←** 」選擇「 **Yes** 」打開


![**VNC 遠端桌面功能啟用成功！**](/assets/99db2a1fbfe5/1*sTZ8x9M-_5FRwdqy4mKvPw.png){:target="_blank"}

**VNC 遠端桌面功能啟用成功！**


![使用 「 **→** 」直接切到「 **Finish** 」退出設定介面。](/assets/99db2a1fbfe5/1*81Y7wZjbSS8Tf5Z_OHi3Rw.png){:target="_blank"}
...
![點選「 **Connect** 」。](/assets/99db2a1fbfe5/1*83cR8b2ajhPc1IwariNVBw.png){:target="_blank"}

點選「 **Connect** 」。


![點選「 **ＯＫ** 」。](/assets/99db2a1fbfe5/1*B0esYM-GvrYUVXIwpq4vvQ.png){:target="_blank"}

點選「 **ＯＫ** 」。


![**輸入登入帳號密碼** ，同 SSH 連線，帳號 **`pi`** 預設密碼 **`raspberry`** 。](/assets/99db2a1fbfe5/1*jJ8cdRrc4bGHDxPvF7xXhw.png){:target="_blank"}

**輸入登入帳號密碼** ，同 SSH 連線，帳號 **`pi`** 預設密碼 **`raspberry`** 。


![**成功連入！**](/assets/99db2a1fbfe5/1*vIUEmBrO-t_-6xy_kPNLNQ.png){:target="_blank"}
...
![設定語言、地區、時區。](/assets/99db2a1fbfe5/1*w9qXfybKr4REKN8hrJJUBw.png){:target="_blank"}

設定語言、地區、時區。


![更改樹莓派預設密碼，輸入你要設定的密碼。](/assets/99db2a1fbfe5/1*xeb6Pr5FUwQGYHhzmid-6w.png){:target="_blank"}

更改樹莓派預設密碼，輸入你要設定的密碼。


![直接下一步「 **Next** 」。](/assets/99db2a1fbfe5/1*o-LCjlYXdW7hmxYjIE6Axw.png){:target="_blank"}

直接下一步「 **Next** 」。


![設定使用 WiFi 連線，之後就不用在插線了。](/assets/99db2a1fbfe5/1*NPZqliJZslnmvzzkW-Zj6g.png){:target="_blank"}
...
![是否要更新當前作業系統，不趕時間就選「 **Next** 」更新吧！](/assets/99db2a1fbfe5/1*lsnk0BDb_z1VKkXYxUi7fg.png){:target="_blank"}
...
![更新完成後，點擊「 **Restart** 」重新啟動。](/assets/99db2a1fbfe5/1*Xgm6NMQNoom_Zee3QHWXZg.png){:target="_blank"}
...
![](/assets/99db2a1fbfe5/1*feOCt_Gyy8DEW7qHA2bpQw.png){:target="_blank"}
...
![](/assets/99db2a1fbfe5/1*Zk_cWdHZ4Um5zCX4dr5IdQ.png){:target="_blank"}
...
![](/assets/99db2a1fbfe5/1*Jm3Ykku3Yll1aiuKWbR-EQ.png){:target="_blank"}
...
![](/assets/99db2a1fbfe5/1*uMEuC33I-R6KlLxS-L6Grw.png){:target="_blank"}
...
![](/assets/99db2a1fbfe5/1*IFt2yQBfKfooraaAgCxGkA.jpeg){:target="_blank"}
...
![](/assets/99db2a1fbfe5/1*HC1CSkt1RpBXYEZ3aa8Eyw.png){:target="_blank"}



![](/assets/99db2a1fbfe5/1*Wi1np5MvjBkwJkInD49aRA.png){:target="_blank"}
...
![](/assets/99db2a1fbfe5/1*L8-E7jZqv6TjO4zKaayAuA.png){:target="_blank"}
...
![](/assets/99db2a1fbfe5/1*P_3Zg1GDuUVKJyO-kknCLA.png){:target="_blank"}
...
![](/assets/99db2a1fbfe5/1*nS68ECAURNSVbuJRYdhCvw.png){:target="_blank"}


備份完成後， [下載](http://www.imactools.com/iphonebackupviewer/download/mac){:target="_blank"}{:target="_blank"} 安裝備份查看軟體： [**iBackupViewer**](http://www.imactools.com/iphonebackupviewer/download/mac)

打開「 **iBackupViewer** 」
> 初次啟動會要你去 Mac「系統偏好設定」\- 「安全性與隱私權」\-「隱私權」\-「\+」\- 加入「iBackupViewer」
\ **_*_**  **_如有隱私顧慮可關閉網路使用這套軟體、並在使用後移除_**



![](/assets/99db2a1fbfe5/0*VMTW7WxQEl_ZFU7E.png){:target="_blank"}


再次打開「 **iBackupViewer** 」成功讀取到備份檔後，點擊「剛備份的手機」


![選擇「 **App Stroe** 」Icon](/assets/99db2a1fbfe5/1*Qqyp11Gc-dnK1Me08KKwbw.png){:target="_blank"}

選擇「 **App Stroe** 」Icon


![左方找到「米家 APP \(MiHome\.app\)」\-> 右方找到「 **數字\_mihome\.sqlite」** 這個檔案並「 **選擇** 」 \-> 右上角「 **Export** 」\-> 「 **Selected Files** 」](/assets/99db2a1fbfe5/1*VlGVYTHKG88GIiH4C745Vg.png){:target="_blank"}
...
[[**SQLite Viewer**](https://inloop.github.io/sqlite-viewer/){:target="_blank"}{:target="_blank"} 
[_sqlite file viewer_ inloop\.github\.io](https://inloop.github.io/sqlite-viewer/)](https://inloop.github.io/sqlite-viewer/)
...
![](/assets/99db2a1fbfe5/1*VWdrF905GGB_yXrCD5CpPg.png){:target="_blank"}
...
![「 **6d304e6867384b704b4f714d45314a34** 」就是我們要的 Token 結果！](/assets/99db2a1fbfe5/1*aQ7RfRx9ATjflYgMysnn3A.png){:target="_blank"}
...
![](/assets/99db2a1fbfe5/0*OvqmDU7ARvoG96J0.jpeg){:target="_blank"}
...
![](/assets/99db2a1fbfe5/1*V7hZyogacXS9m_XN4qVtFw.png){:target="_blank"}
...
![](/assets/99db2a1fbfe5/0*fHtbNC-8IL9KQUyu.jpeg){:target="_blank"}
...
![](/assets/99db2a1fbfe5/1*vwe7fapof2mA4me_3_HyfA.png){:target="_blank"}
...
![](/assets/99db2a1fbfe5/1*N_N5_WCnHNsepVv7HvAjmQ.jpeg){:target="_blank"}
...
![](/assets/99db2a1fbfe5/1*VxEYnHaBwQVLxxXOLb1Jkg.png){:target="_blank"}
...
![](/assets/99db2a1fbfe5/1*R1bxhdiGuY3SyFnrhCO6iw.png){:target="_blank"}



![](/assets/99db2a1fbfe5/1*05s08YdF6vQUWAG7nmTnfA.png){:target="_blank"}
...
![](/assets/99db2a1fbfe5/1*1fQJ9UTCJRghUk00iT2WcQ.png){:target="_blank"}
...
![App Store 搜尋「Yeelight」安裝](/assets/99db2a1fbfe5/1*3m-UOoI7uam4a_N5dxU5VQ.png){:target="_blank"}

App Store 搜尋「Yeelight」安裝


![](/assets/99db2a1fbfe5/1*G9-12giq1DVIw5zTKOaF4A.png){:target="_blank"}



![](/assets/99db2a1fbfe5/1*usLJKkehTDKeeFG95KDe4g.png){:target="_blank"}



![安裝完打開 Yeelight APP \-> 「增加裝置」\-> 找到「米家檯燈」\-> 重新配對綁定](/assets/99db2a1fbfe5/1*cWBMAqa_xkL01SoURNSO8g.png){:target="_blank"}

安裝完打開 Yeelight APP \-> 「增加裝置」\-> 找到「米家檯燈」\-> 重新配對綁定


![最後一步記得打開「 **區域網路控制** 」](/assets/99db2a1fbfe5/1*8un0THsUf3ZesFPGSj_p-g.jpeg){:target="_blank"}
...
![](/assets/99db2a1fbfe5/1*vyAiFirZgDB6_OSsHIdEPw.jpeg){:target="_blank"}
...
![](/assets/99db2a1fbfe5/1*w7WnAn3XHNW2f5fJbRd_Zw.jpeg){:target="_blank"}



![](/assets/99db2a1fbfe5/1*ph8BfcF0ivvlZyKNF9mubQ.png){:target="_blank"}



![另外可以在「設定」\->「控制中心」\->「自訂」中將「家庭」APP 拉上去就能在下拉控制中心中快速操作 HomeKit \!](/assets/99db2a1fbfe5/1*e1FAJuyCLOWEkA6MAeENkA.jpeg){:target="_blank"}
...
還有另一個智慧家庭的平台 [Homeassistant](https://www.home-assistant.io/){:target="_blank"}{:target="_blank"} 可以刷入樹莓派使用（ **但請注意：需要 2A 的電源才有辦法啟動** ）； [Homeassistant](https://www.home-assistant.io/) 我也有灌來玩玩看，全 GUI 圖型操作，點一點就能串入家電；之後再來深入研究，感覺他等同於另一個米家平台而已，如果有很多不同廠商的 IOT 元件，更適合使用這個。
#### 參考資料
...
_Converted [Medium Post](https://medium.com/zrealm-life/%E6%89%93%E9%80%A0%E8%88%92%E9%81%A9%E7%9A%84-wfh-%E6%99%BA%E6%85%A7%E5%B1%85%E5%AE%B6%E7%92%B0%E5%A2%83-%E6%8E%A7%E5%88%B6%E5%AE%B6%E9%9B%BB%E7%9B%A1%E5%9C%A8%E6%8C%87%E5%B0%96-99db2a1fbfe5) by [ZMediumToMarkdown](https://github.com/ZhgChgLi/ZMediumToMarkdown)._
