...
![photo by picjumbo\.com](/assets/99db2a1fbfe5/1*qZeTn0r2u_MKJXubV17XvQ.jpeg "photo by picjumbo\.com"){:target="_blank"}
...
![Raspberry Pi 3B \(special thanks to Lu Xun Huang\)](/assets/99db2a1fbfe5/1*go-wGMdV1VVbJ3c00rh0_w.jpeg "Raspberry Pi 3B \(special thanks to Lu Xun Huang\){:target="_blank"}")
...
[SQLite Viewer
sqlite file viewerinloop\.github\.io](https://inloop.github.io/sqlite-viewer/){:target="_blank"}
...
3. 小米掃地機器人： [homebridge-mi-robot_vacuum](https://github.com/YinHangCode/homebridge-mi-robot_vacuum){:target="_blank"}
