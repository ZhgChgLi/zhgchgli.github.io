...
![剪貼簿被 APP 讀取時的頂部提示訊息](/assets/8a04443024e2/1*s-2FT2L_BD8vGH7uHRLrsw.png){:target="_blank"}
...
![Google Search](/assets/8a04443024e2/1*bwxJ9w2WVJy8HT20vdj7eA.png){:target="_blank"}
...
![](/assets/8a04443024e2/1*nMC1H2vRId1Y-7iC3WusaQ.jpeg){:target="_blank"}
...
如果是自己實作 DeepLink 可以參考 Firebase\-iOS\-SDK \ [#](https://github.com/firebase/firebase-ios-sdk/pull/5905){:target="_blank"}{:target="_blank"}  [PR 5905](https://github.com/firebase/firebase-ios-sdk/pull/5905) 的修改：
```swift
