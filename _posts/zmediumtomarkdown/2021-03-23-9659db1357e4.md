...
[_nvm is a version manager for node \.** js, designed to be installed per \-** user, and invoked per \-** shell \.** nvm works on any…_ github \.** com](https://github.com/nvm-sh/nvm#installing-and-updating)](https://opengraph.githubassets.com/9d61b4d25fdd650dae3570472ae69424bba442735cd9c351150e0bcf24b8c87c/nvm-sh/nvm "[**nvm \-** sh/nvm**](https://github.com/nvm-sh/nvm#installing-and-updating) 
...
`successful _ transactions: 100` 表示 100 次都執行成功。
...
- [https://firebase \.** google \.** com/docs/firestore/solutions/counters \#** node \.** js \_** 1](https://firebase.google.com/docs/firestore/solutions/counters#node.js_1){:target="_blank"}
