...
![Photo by Carlos Muza](/assets/9659db1357e4/1*RVPRxqz2VUuY7NGXSXzmtw.jpeg "Photo by Carlos Muza"){:target="_blank"}
...
[![nvm\-sh/nvm
nvm is a version manager for node\.js, designed to be installed per\-user, and invoked per\-shell\. nvm works on any…github\.com](https://opengraph.githubassets.com/ac9949bf57154838d2acb32017991009821e3fe05d155c3fc4f5c145cf8d30c6/nvm-sh/nvm "nvm\-sh/nvm
nvm is a version manager for node\.js, designed to be installed per\-user, and invoked per\-shell\. nvm works on any…github\.com"){:target="_blank"}](https://github.com/nvm-sh/nvm#installing-and-updating)
...
- [https://firebase.google.com/docs/firestore/solutions/counters#node.js_1](https://firebase.google.com/docs/firestore/solutions/counters#node.js_1){:target="_blank"}
