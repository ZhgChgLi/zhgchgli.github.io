...
last_modified_at: 2021-02-24T01:33:46.431Z
...
![NT$ 1,795 支援米家、Apple HomeKit](/assets/c3150cdc85dd/1*Aa9zfAh7xclVOZS0IkcaMQ.jpeg){:target="_blank"}

NT$ 1,795 支援米家、Apple HomeKit
#### [米家 LED 智慧檯燈](https://www.mi.com/tw/smartlamp/){:target="_blank"} ：


![NT$ 995 僅支援米家](/assets/c3150cdc85dd/1*PCaRI8AroRgFELEA1elaiA.jpeg){:target="_blank"}
...
![只需四步驟](/assets/c3150cdc85dd/1*pv62RZ_TjL8X6t-gXnwWtQ.jpeg){:target="_blank"}
...
![](/assets/c3150cdc85dd/1*0Rm1Ij86bD-fld-N-N1qJw.jpeg){:target="_blank"}
...
![運作比較](/assets/c3150cdc85dd/1*q2ctcxaaxLFExKXd-9NjPg.png){:target="_blank"}
...
安裝 [node\.js](https://nodejs.org/en/){:target="_blank"} ： [點我](https://nodejs.org/dist/v12.6.0/node-v12.6.0.pkg){:target="_blank"}{:target="_blank"} [下載](https://nodejs.org/dist/v12.6.0/node-v12.6.0.pkg) ，安裝即可
...
![](/assets/c3150cdc85dd/1*RBRWT93L_abbhzTItL9Mhg.png){:target="_blank"}
...
![](/assets/c3150cdc85dd/1*n0TIhqyCoKZo7--ePZwuLA.jpeg){:target="_blank"}
...
![打開 Itunes 介面](/assets/c3150cdc85dd/1*0ewSMEH7K2rzUlUtSB61vw.png){:target="_blank"}
...
![](/assets/c3150cdc85dd/1*kEOxJCkOxDRuFfoxumssgA.png){:target="_blank"}


再次打開「iBackupViewer」成功讀取到備份檔後，點擊右上角切換到「Tree View」模式


![](/assets/c3150cdc85dd/1*R4l6tRzDaqtiN7xutPKtQg.png){:target="_blank"}
...
![](/assets/c3150cdc85dd/1*oRK8tHqom2tnR3CE5xz_-w.png){:target="_blank"}
...
![](/assets/c3150cdc85dd/1*ZXTe6MEFXjYhqtf9uAJWwQ.png){:target="_blank"}
...
![](/assets/c3150cdc85dd/1*Zh_BWLwMUg5pOxFEVipgiQ.png){:target="_blank"}
...
![](/assets/c3150cdc85dd/1*vwCS3QHu285oCrChau9mpw.png){:target="_blank"}


這時會出現HomeKit QRCode 讓您掃描加入配件（步驟如上面提到的，Apple HomeKit裝置加入方式）


![](/assets/c3150cdc85dd/1*CB76x9ryWBve2bssFd0nzA.jpeg){:target="_blank"}
...
![](/assets/c3150cdc85dd/1*uuaLjWduzC5RrOf-gd2-Jw.jpeg){:target="_blank"}
...
![](/assets/c3150cdc85dd/1*GTcap563FDdC0TsH09hZww.jpeg){:target="_blank"}
...
![](/assets/c3150cdc85dd/1*3jm0Kd4545DcmzNtPY-dXA.jpeg){:target="_blank"}
...
![](/assets/c3150cdc85dd/1*s33BtesqfNSUNyyR069m_Q.jpeg){:target="_blank"}
...
![](/assets/c3150cdc85dd/1*VSArlFmoFERbjH13Cns5TQ.jpeg){:target="_blank"}
...
![](/assets/c3150cdc85dd/1*tCpQ3io2Q2DDCVFxJpBm_g.png){:target="_blank"}
...
![](/assets/c3150cdc85dd/1*Rm101LKv29Avb5wv4isg4A.jpeg){:target="_blank"}
...
![](/assets/c3150cdc85dd/1*Kk6AMnhSYP4sM8JD_66Iow.jpeg){:target="_blank"}
...
![](/assets/c3150cdc85dd/1*SXYVBHk9-pMD8YufRQA4zw.png){:target="_blank"}


這時候就可以選擇右上角「＋」使用「家庭」APP直接新增自動化腳本！！


![](/assets/c3150cdc85dd/1*qbtjNCj9mOvjuX7an6rhXw.jpeg){:target="_blank"}
...
![](/assets/c3150cdc85dd/1*q_ui00ruJl1Fd3_5M-0EhQ.png){:target="_blank"}
...
![看字就好，這個就是](/assets/c3150cdc85dd/1*xLM5-khndWjvEDdTaFiPfw.png){:target="_blank"}
...
![](/assets/c3150cdc85dd/1*leO3Z492pJPh3hEASYr-ww.jpeg){:target="_blank"}
...
![](/assets/c3150cdc85dd/1*ZjdH5A0QnLq2LNh9lWvCCw.jpeg){:target="_blank"}
...
![](/assets/c3150cdc85dd/1*DMmicpzKUIr2xtN8JtP3wQ.png){:target="_blank"}


也可從 [Apple Watch](../a2920e33e73e/) 上控制元件！
\ _*_  _如果手錶APP一直出現空白請刪除重裝手錶或手機APP，這個APP真的蠻多BUG的_
#### 智慧有了，那怎麼自動化呢？
...
![](/assets/c3150cdc85dd/1*e9ld6Qn7D64CG-DZA1vAsA.jpeg){:target="_blank"}
...
![](/assets/c3150cdc85dd/1*-rjtmZ6PHzSzOoBvjJ-FJQ.jpeg){:target="_blank"}


點擊右上角「\+」建立捷徑 \-> 點右上完成下方的設定按鈕 \-> 名稱 \-> 輸入名稱（建議用英文，因為等等還要用到）


![](/assets/c3150cdc85dd/1*5aUsslYvZvlFiSQYJrGgRw.jpeg){:target="_blank"}
...
![](/assets/c3150cdc85dd/1*5tXhFP4uT1ySSFAZnnDQGw.jpeg){:target="_blank"}
...
![](/assets/c3150cdc85dd/1*2vs32eIxtEmvqzxOsDLGEw.jpeg){:target="_blank"}


設定位置 \-> 點擊「Create trigger」確定 \-> 換點下面「\+that」\-> 搜尋「notification」


![](/assets/c3150cdc85dd/1*bVmWLH5tUcko5eeOmnR3kQ.jpeg){:target="_blank"}
...
![點選通知就會在背景自動執行場景](/assets/c3150cdc85dd/1*a9zXd_JSpz9IKInJlPoJ1w.png){:target="_blank"}
...
![](/assets/c3150cdc85dd/1*lyzEU2cKxafbnXkWnR7ltg.jpeg){:target="_blank"}
...
_Converted [Medium Post](https://medium.com/zrealm-life/%E6%99%BA%E6%85%A7%E5%AE%B6%E5%B1%85%E5%88%9D%E9%AB%94%E9%A9%97-apple-homekit-%E5%B0%8F%E7%B1%B3%E7%B1%B3%E5%AE%B6-c3150cdc85dd) by [ZMediumToMarkdown](https://github.com/ZhgChgLi/ZMediumToMarkdown)._
