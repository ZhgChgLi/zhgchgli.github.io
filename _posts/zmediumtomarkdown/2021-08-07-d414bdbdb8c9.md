...
last_modified_at: 2021-11-21T14:53:44.176Z
...
![Photo by [Lukas Blazek](https://unsplash.com/@goumbik?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText){:target="_blank"}{:target="_blank"}](/assets/d414bdbdb8c9/1*U6CDgIAMt2l2vDoFqhwv6A.jpeg)

Photo by [Lukas Blazek](https://unsplash.com/@goumbik?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)
### 起源

最近在優化 iOS App CI/CD 的流程，使用 Fastlane 作為自動化工具；打包上傳後如果要繼續完成自動送審步驟 \( `skip\_submission=false` \)，就需要等蘋果完成 Process 大概需要浪費 30~40 mins 的 CI Server 時間，因為蘋果 App Store Connect API 並不完善，Fastlane 也只能每分鐘去檢查一次上傳的 Build 是否處理完成，非常浪費資源。


![](/assets/d414bdbdb8c9/1*JXuVoKM-gGJwfvF7tXY1nQ.png){:target="_blank"}
...
![](/assets/d414bdbdb8c9/1*57FOYivs5toW2aipgRVCeg.jpeg){:target="_blank"}
...
![](/assets/d414bdbdb8c9/1*2fmqWCAMiM2UeuGss7VzzA.jpeg){:target="_blank"}



![](/assets/d414bdbdb8c9/1*sndRqvnELhCshb6yyPFhqg.jpeg){:target="_blank"}
...
![](/assets/d414bdbdb8c9/1*qdoLTotLTaeZPsEHaJ8C7Q.jpeg){:target="_blank"}
...
![](/assets/d414bdbdb8c9/1*w4E7wf-Kf8XVFxowmDopIw.png){:target="_blank"}
...
![](/assets/d414bdbdb8c9/1*yB5s_5rBr4l6hid21huJMQ.jpeg){:target="_blank"}
...
![](/assets/d414bdbdb8c9/1*qNXxtTLzEnlArl4UTTWQMw.jpeg){:target="_blank"}


在 Gmail 點擊右上進階搜尋圖標按鈕，輸入要轉發的信件規則條件，例如來自： `no\_reply@email\.apple\.com` \+ 主題是 `is now available to test\.` ，點擊「Search」查看篩選結果是否如預期；如果正確可以點擊 Search 旁的「Create filter」按鈕。


![或直接在信件裡上方點 Filter message like these 就能快速建立篩選條件](/assets/d414bdbdb8c9/1*i7grToZwE_ixwJTEjI9qtw.jpeg){:target="_blank"}

或直接在信件裡上方點 Filter message like these 就能快速建立篩選條件


![](/assets/d414bdbdb8c9/1*n_nbqgIlE-E1eaW5QfqkWg.jpeg){:target="_blank"}

> 這按鈕設計很反人類，第一次找一直沒看到。



![](/assets/d414bdbdb8c9/1*6zlooS-cMr5LEVX2TW5I_w.jpeg){:target="_blank"}
...
![](/assets/d414bdbdb8c9/1*AgGLiLsyvenK-LRWI9rlKg.png){:target="_blank"}
...
![](/assets/d414bdbdb8c9/1*DUcwdLTKt33Fa-jNlW8MkA.png){:target="_blank"}



![](/assets/d414bdbdb8c9/1*v8Z-5vEM043F82TMiZk2lw.png){:target="_blank"}


選擇訊息想要傳到的 Channel。


![](/assets/d414bdbdb8c9/1*SRciom_ygU0JDKK9ATY1FQ.png){:target="_blank"}


記下最上方的「Webhook URL」


![](/assets/d414bdbdb8c9/1*kp1QDIEwzQtmfzUwZIDTSg.png){:target="_blank"}
...
![](/assets/d414bdbdb8c9/1*QfgJL_Xb9JhgQnPGjU2CXg.png){:target="_blank"}
...
![](/assets/d414bdbdb8c9/1*aZkQGA3N1cquMLt1wyDGFg.jpeg){:target="_blank"}
...
![](/assets/d414bdbdb8c9/1*JHHTQCWNUI-aNPBB6y4iAA.jpeg){:target="_blank"}



![](/assets/d414bdbdb8c9/1*ltXGtEVxkdde1qHGxy3wMw.png){:target="_blank"}


若出現 「Authorization Required」則點選「Continue」完成驗證


![](/assets/d414bdbdb8c9/1*hIgRtqKEFs0tsXDxfNTaOg.png){:target="_blank"}
...
![](/assets/d414bdbdb8c9/1*QUkmTD1WlEzw7cqW97ll6Q.png){:target="_blank"}


點擊「Allow」


![](/assets/d414bdbdb8c9/1*TInHsY7Fwb9jHuKJkMJIsw.jpeg){:target="_blank"}
...
![](/assets/d414bdbdb8c9/1*2Ok6gD5E7F1uqyzgVpoJ8A.jpeg){:target="_blank"}


在 Apps Script 左方選單列，選擇「觸發條件」。


![](/assets/d414bdbdb8c9/1*1xb9xGGkgx6PkhWlWc7HiQ.jpeg){:target="_blank"}


左下角「\+ 新增觸發條件」。


![](/assets/d414bdbdb8c9/1*ujCxCH3f8HTvSOP5o4xvmA.jpeg){:target="_blank"}
...
![](/assets/d414bdbdb8c9/1*LBAlTvz46NJCYgVv1DrfYQ.png){:target="_blank"}
