...
### 免費的其他選擇
1. [AppFollow](https://appfollow.io/) ：使用 Public URL API (RSS)，只能說堪用吧。
2. [feedis.io](https://feedis.io/product/proxime/features) ：使用 Private URL API，需要把帳號密碼給他們。
3. [TradeMe/ReviewMe](https://github.com/TradeMe/ReviewMe) ：自架服務(node.js)，我們原先用這個，但遇到前述問題。
4. [JonSnow](https://github.com/saiday/JonSnow) ：自架服務(GO)，支援一鍵部署到 heroku，作者： [@saiday](https://twitter.com/saiday)
