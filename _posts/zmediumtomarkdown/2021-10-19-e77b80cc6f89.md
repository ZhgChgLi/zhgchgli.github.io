...
![](/assets/e77b80cc6f89/1*-luP3wtJr1XJ9Vq3M0sQLA.png){:target="_blank"}

### 成果


![Pinkoi iOS Team 實拍圖](/assets/e77b80cc6f89/1*gJhRllB0sQb-W3P7tQAQ6g.jpeg){:target="_blank"}
...
![](/assets/e77b80cc6f89/1*ABFLOY1AEKkSJah6EVJEkg.png){:target="_blank"}
...
![](/assets/e77b80cc6f89/1*dvjnubHWwYF7Bhz8SiuuLA.jpeg){:target="_blank"}


首先到 Firebase 專案 \-> Crashlytics \-> 列表右上方的「•••」\-> 點擊前往「BigQuery dataset」。


![](/assets/e77b80cc6f89/1*TEJY6kH9guplY1kZvOfxzw.jpeg){:target="_blank"}
...
![](/assets/e77b80cc6f89/1*4atxy5aRHkQrVvRE1GE2AQ.jpeg){:target="_blank"}
...
![](/assets/e77b80cc6f89/1*K0got1UinY2y4cFxZ2HM3w.jpeg){:target="_blank"}


點擊右上方的「Query」可開啟帶有輔助 SQL Builder 的介面\(如對 SQL 不熟建議使用這個\)：


![](/assets/e77b80cc6f89/1*fxget7SOAb7hlnKDWhvmFQ.jpeg){:target="_blank"}


或直接點「COMPOSE NEW QUERY」開一個空白的 Query Editor：


![](/assets/e77b80cc6f89/1*3T7vHuR4LoojnZ5xe6LWfg.png){:target="_blank"}


不管是哪種方法，都是同個文字編輯器；在輸入完 SQL 之後可以預先在右上方自動完成 SQL 語法檢查和預計會花費的查詢額度\( `This query will process XXX when run\.` \)：


![](/assets/e77b80cc6f89/1*wGMkfqGPg277BzuUgOag1w.jpeg){:target="_blank"}
...
![](/assets/e77b80cc6f89/1*YtbpV4tm0Z_iwrOA0AJ9Jg.jpeg){:target="_blank"}
...
![](/assets/e77b80cc6f89/1*epwnVrltY7ei8_osPnbaww.jpeg){:target="_blank"}
...
![](/assets/e77b80cc6f89/1*Pt-falvO3uCtfSrJpNZeZQ.png){:target="_blank"}


**執行測試一次沒問題後，可以開始設定排程自動執行：**


![](/assets/e77b80cc6f89/1*-lI8vcewsS5ZRt5vR1iAkg.jpeg){:target="_blank"}


於左方選擇鬧鐘圖案，再選擇右下方「\+ Add Trigger」。


![](/assets/e77b80cc6f89/1*V20eoW30mHYnHkhUk5uKnw.png){:target="_blank"}
...
![範例成果圖](/assets/e77b80cc6f89/1*J4k9SMFX8hU7-M_zX3wDtw.jpeg){:target="_blank"}
