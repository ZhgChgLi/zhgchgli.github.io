...
- ⭐️️️ 2026 年 3 月 1 日， **使用 Self\-hosted Runner 需要多支付服務維運費，每分鐘 $0\.002 美元\(不分 OS\)、等於 500 分鐘花費 1 美元，目前來看還是很划算。** ️
- Public repository 上執行仍保持相同到免費額度。


**GitHub 也會投入更多資源提升 Gitub Actions 功能：**
...
> _自己買一台最新型號的 [Mac Mini 10\-core\(M4\)](https://www.apple.com/tw/shop/buy-mac/mac-mini){:target="_blank"} **約 $600 USD** ，買一台放在公當 Self\-hosted Runner 大約一年就回本了；更別說效能更好更快而且用量幾乎等於無上限\( **維運費微乎其微** \)。_ 
