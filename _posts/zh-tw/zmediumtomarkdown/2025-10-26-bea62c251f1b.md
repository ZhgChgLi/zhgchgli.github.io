...
### 日本海外購物寄送台灣教學 — 使用樂天集運購買樂天拍賣與 Amazon 商品 \(Horie 鈦杯\) 最快 4 天到貨

想要的東西自己買，用樂天集運購買日本商品寄回台灣的紀錄與教學，以購買 Horie 鈦杯為例。
...
- 因為我要刻字，所以需要 7–10 天製作，另外又買了雜誌多等了雜誌到樂天集運的時間。
- 單純看集運時間，集運收到貨只花 1 天、集運從打包出貨到收到只花 3 天，可以說是非常快速！
- 花費總計含運費：NT $4,744 入手。\(細節請看內文，因為買的少所以運費較貴\)

### [樂天集運 — Rakuten Global Express](https://secure.globalexpress.rakuten.co.jp/mypage/register/invite?key=a6nn9r3fq6j4sskcsOrXE%2Bgdygp0zER%2FMe83%2FUDPw6k7LFkMFZBfgN0hX48E%3D){:target="_blank"}

想說既然都要買日本樂天市場的東西，就直接試用樂天的集運服務；當然樂天集運也不只侷限於購買樂天的東西，其他電商平台例如：日本亞馬遜\(Amazon JP\)、日本 Yahoo 購物 / Yahoo 拍賣、Mercari、Biccamera…等等都能寄送。
- 可以累積樂天點數！及使用點數抵付！

#### 使用樂天集運購買樂天商品的特殊保障

除了提供集運服務之外， **使用樂天集運購買樂天市場的商品** 還額外提供以下保障：
- 賠償服務：已付款但商品未送達
...
可以使用 [官方工具](https://globalexpress.rakuten.co.jp/estimate/?l-id=top_estimate){:target="_blank"} 試算集運運費價格。
...
註冊完樂天到 [樂天集運](https://secure.globalexpress.rakuten.co.jp/mypage/register/invite?key=aanar03e62e0ckog4nWPIFcV7FTuy6JGEeCL1HwxrPgcSjKRlGHs1GY6PkH0%3D){:target="_blank"} 預設就是已登入狀態。
1. 先點擊語言換成繁體中文方便操作
2. 點擊我的頁面開通集運
...
- 集運倉地址務必要輸入到最後的 `白石町6–1 RGXセンター XXXXXXX` 英文數字編號，那才是你的專屬識別地址。
- 可點擊「立即新增」直接把地址新增到樂天帳戶



> _有了這個地址跟電話號碼就能在日本各大電商網站進行購物跟寄送囉！不過為了確保集運能安全寄回到你手上， **請先「繼續完成本人認證手續」再去購物網站購買、寄送商品。**_ 
...
都填好規格內容後點「かごに追加」加入購物車，お届け先 收件人資訊選我們樂天集運的「神奈川縣」，下方也會顯示預計配送到樂天集運的時間、免運費；都加好後點上方購物車結帳：
...
- **お届け先：** 寄送資訊，可以直接選擇剛樂天集運新增的集運地址，或自行新增集運地址\(集運地址請務必輸入到最後編號部分\)
...
收到 HORIE 出貨通知後約 1–3 天就送達樂天集運倉庫了。
### 從日本亞馬遜 Amazon JP 寄送到樂天集運

這次除了買 HORIE 鈦杯之外，還從 日本亞馬遜 Amazon JP 買了一個雜誌，打算一起集運寄回台灣。


![](/assets/bea62c251f1b/1*70bmfM40fgui1EptFuLylA.png)


在購物網站上同樣的操作只要記得照樂天集運的你的收件資訊填寫寄送地址、聯絡電話\(填集運的\)。
#### \(非樂天市場購物\) 貨件到貨事前登記

非樂天本家買的商品寄送到集運建議在下單後登記一下。
...
輸入其他平台購買的店家、商品資訊跟金額。
#### 日本亞馬遜 Amazon JP 購買商品\-樂天集運到貨通知


![](/assets/bea62c251f1b/1*eWxfcNY_Wsr7VT9-5ZuFtQ.png)


都完成後等商家出貨，寄送到達樂天集運也會收到通知。
### 樂天集運寄回台灣

[樂天集運最長可以免費保管貨物 30 天](https://globalexpress.rakuten.co.jp/faq/detail?id=99){:target="_blank"} ，東西都寄到集合好之後就可以請求包裝發貨囉。
...
到此從日本樂天網站註冊、樂天集運使用、下單購物、出貨、寄回台灣、EZWay，都完成了，就等貨物到手！
### 樂天集運、 [Horie 鈦杯](https://a.r10.to/hkPx9m){:target="_blank"} 開箱

10/14 請求樂天集運出貨，10/16 就收到了！
...
Horie 鈦杯寄送的紙箱原封不動放在樂天集運的紙箱中。


> _感覺可以在集運包裝時勾選去除原本的包裝減少體積與重量，節省運費。_ 
