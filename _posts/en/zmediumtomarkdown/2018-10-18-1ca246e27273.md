...
- iPhone
- iOS App Development
title: Boost iOS App UX｜Implement 3D Touch with Swift for Instant Interaction
---
...
![If you test carefully, you'll notice the effect above: when scrolling the CollectionView, part of the image has already slid out of the screen, and pressing it then causes the situation shown above 😅](/assets/1ca246e27273/1*LBgSqm8CTdBPycGnuYNMkA.png)
