...
- Python
- App Development
title: App Lifecycle Management｜Mitmproxy & Apple Configurator for Preserving Removed
  Apps
---
...
3. After exiting the recording interface, click the "v" next to the 🔴, and select your connected phone for the screen and speaker.
...
A long time ago, the [reverse engineering article](../7498e1ff93ce/) mentioned this, but this time we only need to back up the .ipa file without cracking; everything is done using Apple’s official tools.
