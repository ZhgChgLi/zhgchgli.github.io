...
description: Discover how LINE Bank users can quickly deposit to Firstrade with only
  150 NT fee, complete account upgrade steps, set up scheduled transfers, and apply
  for fee subsidies through this detailed step-by-step tutorial.
image:
...
### Step-by-Step Guide — LINE Bank Deposit to Firstrade with Fast Credit, Only 150 TWD Fee, and Account Upgrade / Scheduled Transfer / Fee Reimbursement Application Tutorial
...
- Multiple flexible high-interest deposit plans available for you to choose and combine freely

- Personal Loan: Fast / Consolidated / Easy 10-Year Repayment

- Securities: Invest in Taiwan stocks starting from 100 TWD

#### Until 2025/12/31 — US remittance fee only 150 TWD

[This is](https://corp.linebank.com.tw/news/87ce77b7-a474-46a8-b00b-a9b1503550a2){:target="_blank"} the biggest reason we use LINE Bank. Until the end of 2025, depositing to Firstrade with a LINE Bank account only costs a 150 TWD fee, with no telegraphic transfer or other fees.
...
This time, setting up the designated account requires using the Citizen Digital Certificate because LINE Bank has no physical branches. So, you need to visit the household registration office to apply for the certificate before use, which is more troublesome than going directly to a bank.

### Advantages of Firstrade

- Easy account opening, simple interface and features, beginner-friendly for US stocks
...
![[Deposit over $10,000 USD to apply for up to $25 USD fee rebate](https://www.firstrade.com/zh-TW/accounts/wire-fee-rebate){:target="_blank"} (up to three times per month)](/assets/e4d139fe0685/1*-4JN2hY_QP3oZaon2BES0A.png)

[Deposit over $10,000 USD to apply for up to $25 USD fee rebate](https://www.firstrade.com/zh-TW/accounts/wire-fee-rebate){:target="_blank"} (up to three times per month)
...
Select "Transfer" → "Transfer Information" to open a PDF file, which you can save for easy reference when making deposits later:
...
> *The larger the transfer amount, the lower the fee. **Firstrade offers a fee rebate of up to $25 USD per transfer for single deposits over $10,000 USD (about 310,000 TWD), with up to three rebates per month. You must apply within 30 days after the transfer (see tutorial at the end).***

#### Enter Remittance Information

![](/assets/e4d139fe0685/1*5Bc1Gogt-HJRVdh_ygOPbg.png)

**Enter the information from the previous step [Wire Instructions](https://invest.firstrade.com/scripts/fundmgt/wire_instruction/){:target="_blank"}:**

1. Recipient's English Account Name: `Apex Clearing Corporation`

2. Receiving Bank Information — Automatically filled by entering the SWIFT code
...
**Scroll down to continue typing:**
...
5. **⭐️️️️️️ Most Important Remark, Please Be Sure to Fill In**  
   **⭐️️️️️️ Most Important Remark, Please Be Sure to Fill In**  
   **⭐️️️️️️ Most Important Remark, Please Be Sure to Fill In**  
...
The final step is to confirm that the information entered is correct, especially the beneficiary account details and the **memo section**.
...
Seeing this screen means the transfer request is complete. Please wait for the deposit notification.

> *The remittance amounts shown in the images are for reference only. (Some images show 50,000, others 100,000)*

### LINE Bank Transfer Deposit to Firstrade Progress Inquiry
...
- On non-holidays, the transfer can be completed the same day at the fastest. On holidays, it will be processed on the next working day after two days.

- **If the payee information is incorrect, the payment will be rejected, and you will need to pay a return fee to resend the transfer.**

#### The receiving bank has received the funds, but Firstrade hasn't seen the deposit?

This is normal. Although the remittance status on Line Bank shows "Recipient bank has received the funds" and the transfer is complete, Firstrade still needs to wait for a US business day (time) to confirm the funds.

As shown in the above image, although the funds were received on 8/27 at 9:00 AM, Firstrade only confirmed the funds and sent the deposit notification email on 8/28 at 2:10 AM:
...
"My Account" → "Account Records" will also show deposit records for reference.
...
- (After account opening) Basic account: maximum 10,000 per transaction, 30,000 per day, and 50,000 per month.

- (After customer service video call) Upgrade account: single transaction limit up to 50,000, daily limit up to 100,000, monthly limit up to 200,000.

- (After Natural Person Certificate + Customer Service Video Verification) Designated Account: Maximum single transaction of 500,000.

#### Line Bank Account Upgrade

This step is basically upgrading to the basic limit of other banks. **(No need for a citizen digital certificate in this step.)**
...
Clicking will initiate a video call with customer service. You will need to have a video conversation and they may verify your account information (e.g., ask for your current balance). Once confirmed, your account upgrade will be complete.
...
- The designated account requires prior verification with a National ID certificate.

- **The Citizen Digital Certificate verification only supports cards starting with TP07, which contain an NFC chip.**

#### Citizen Digital Certificate Application
...
After submission, you can handle it at any Household Registration Office counter within 7 days (it does not have to be your registered residence).

- **Processing Fee: $250**

- On-site processing and issuance

- Few people apply for the Citizen Digital Certificate at the Household Registration Office, and they usually remain open during lunchtime.

![](/assets/e4d139fe0685/1*zrmIss8K7vrn18f_CGffDg.png)

#### Add Firstrade Overseas Remittance Account in Line Bank
...
The first time binding requires completing "Citizen Digital Certificate Verification" and "Video Verification." Video verification and account upgrade need to be done via video call with customer service to verify account information.
...
> *The NFC range of the Citizen Digital Certificate is a bit short. I tried several times before it worked; on the iPhone, hold the camera near the center of the card and move the card left and right. After a few tries, the verification will succeed.*
...
You need to complete two-factor SMS verification by switching to the newly received message and entering the four-digit code; wait about 1–2 minutes for a confirmation SMS indicating successful verification.
...
- After adding, an exclamation mark will appear at the top right corner, indicating it is not yet active.
...
"My Transfer Records" → "Agreed Transfer Account" → Select Account → Enter Amount → Choose "Transfer via Agreed Account" → All details will be filled automatically.
...
> ***If no remittance information appears, please wait a few more days for the data to arrive. (It may not show immediately after the funds arrive)***

![](/assets/e4d139fe0685/1*U598Ew1kBCBC4fxCjLVv_w.png)

![](/assets/e4d139fe0685/1*-KOs-E0FQ_Wy80GLl581OA.png)

**Select Transfer Record Data:**
...
It takes about five business days to receive the remittance subsidy.
...
> *Technically, **scam emails and fake websites can look exactly the same**, making it hard to tell true from false; regarding the URL:*

> ***Anything other than firstrade.com is a scam! It's all a scam! It's all a scam!***
