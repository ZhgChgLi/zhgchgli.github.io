...
- HTML
- Rendering
title: HTML Parsing Techniques｜Build Custom Parsers for NSAttributedString Rendering
---
...
- [iOS ≥ 12 intermittent crashes issue with no official fix](https://developer.apple.com/forums/thread/115405){:target="_blank"}

- In iOS 15, a [frequent crash issue](../a8c2d26cc734/) occurred. Testing showed a 100% crash rate under low battery conditions (fixed in iOS ≥ 15.2).
...
- [johnxnguyen](https://github.com/johnxnguyen){:target="_blank"} / [Down](https://github.com/johnxnguyen/Down){:target="_blank"}  
  Only supports converting input Markdown to Any (XML/NSAttributedString…), but does not support converting input HTML.
...
> ⚠️ This article simplifies the demo code by reducing abstraction and performance considerations, focusing mainly on explaining the operating principles. For the final results, please refer to the project [Source Code](https://github.com/ZhgChgLi/ZMarkupParser){:target="_blank"}.
...
![[ZMarkupParser](https://github.com/ZhgChgLi/ZMarkupParser){:target="_blank"} [⭐](https://github.com/ZhgChgLi/ZMarkupParser){:target="_blank"}](/assets/2724f02f6e7/1*kXjJnSIJ7x-lSIYtacRrQ.jpeg)
...
> [If you want to support but lack the time, you can give me a ⭐ so this Repo can be seen by more people, increasing the chance for Github experts to contribute!](https://github.com/ZhgChgLi/ZMarkupParser){:target="_blank"}
...
Currently applied in our company's iOS app [pinkoi.com](https://www.pinkoi.com){:target="_blank"}, no issues found. 😄
