...
GitHub 2025/12/14 [最新公告](https://resources.github.com/actions/2026-pricing-changes-for-github-actions/){:target="_blank"} ：



- 2026 年 1 月 1 日：GitHub-hosted Runner 更便宜了，价格下调最高 39%。


- ⭐️️️ 2026 年 3 月 1 日， **使用 Self-hosted Runner 需要多支付服务维运费，每分钟 $0.002 美元(不分 OS)、等于 500 分钟花费 1 美元，目前来看还是很划算。** ️


- Public repository 上执行仍保持相同到免费额度。



**GitHub 也会投入更多资源提升 Gitub Actions 功能：**



- **Scale Set Client：** 简化 Self-hosted Runner 的 **Autoscaling** 。


- **multi-label：支援重启** ，改进 Runner 标签体验。


- **Actions Runner Controller (ARC)** 更新：提升配置、可观察性与版本管理。


- **Actions Data Stream：** 提供接近实时的 workflow/runner 事件数据串流，用于监控跟分析。



[**官方的价格计算器也更新了**](https://github.com/pricing/calculator){:target="_blank"} **：**
...
- Github Hosted Runner — macOS 3-core(M1): $0.062 USD/分钟、1,000 分钟等于 $62 USD


- Self-Hosted Runner — $0.002 USD/分钟、1,000 分钟等于 $2 USD



> *自己买一台最新型号的 [Mac Mini 10-core(M4)](https://www.apple.com/tw/shop/buy-mac/mac-mini){:target="_blank"} **约 $600 USD** ，买一台放在公当 Self-hosted Runner 大约一年就回本了；更别说效能更好更快而且用量几乎等于无上限( **维运费微乎其微** )。*



> *也可以用汰换下来的旧 M1 Macbook Pro 当 Runner = 0 元。*
...
![[Demo Web App (首次使用请参考下方教学)](https://script.google.com/macros/s/AKfycbwNW6N5ozKbIz_E1HK6yFEUtA8KQrUciS-jcPsQptvIKlARmKgLxbQzNu8ksVeg-BmEfg/exec){:target="_blank"}](/assets/c008a9e8ceca/1*yXMeaOELhqdvMCxIJ5ElBw.gif)



[Demo Web App (首次使用请参考下方教学)](https://script.google.com/macros/s/AKfycbwNW6N5ozKbIz_E1HK6yFEUtA8KQrUciS-jcPsQptvIKlARmKgLxbQzNu8ksVeg-BmEfg/exec){:target="_blank"}
...
- [Online Demo](https://script.google.com/macros/s/AKfycbwNW6N5ozKbIz_E1HK6yFEUtA8KQrUciS-jcPsQptvIKlARmKgLxbQzNu8ksVeg-BmEfg/exec){:target="_blank"} 初次使用请参考下图授权(Only For Demo App)：
...
> *这里漏估了 [2026–03–01 起 Self-hosted 需要支付每分钟 $0.002 USD 维运费用](https://resources.github.com/actions/2026-pricing-changes-for-github-actions/){:target="_blank"} ，等于执行 500 分钟需要缴 $1 USD。*
...
Jenkins 全开源免费权掌握在手，GitHub Actions 部分开源但任务派发与执行是 GitHub 封闭的 SAAS 服务；目前政策是 GitHub Actions 完全免费，使用 GitHub Runner 才要付费、使用 self-hosted Runner [自 2026-03-01 起也需要支付每分钟 $0.002 USD 维运费用](https://resources.github.com/actions/2026-pricing-changes-for-github-actions/){:target="_blank"} ；以上收费 Public Repo 都有免费额度。
