...
### 日本海外购物寄送台湾教学 — 使用乐天集运购买乐天拍卖与 Amazon 商品 (Horie 钛杯) 最快 4 天到货



想要的东西自己买，用乐天集运购买日本商品寄回台湾的纪录与教学，以购买 Horie 钛杯为例。
...
- 因为我要刻字，所以需要 7–10 天制作，另外又买了杂志多等了杂志到乐天集运的时间。


- 单纯看集运时间，集运收到货只花 1 天、集运从打包出货到收到只花 3 天，可以说是非常快速！
...
### [乐天集运 — Rakuten Global Express](https://secure.globalexpress.rakuten.co.jp/mypage/register/invite?key=a6nn9r3fq6j4sskcsOrXE%2Bgdygp0zER%2FMe83%2FUDPw6k7LFkMFZBfgN0hX48E%3D){:target="_blank"}



想说既然都要买日本乐天市场的东西，就直接试用乐天的集运服务；当然乐天集运也不只局限于购买乐天的东西，其他电商平台例如：日本亚马逊(Amazon JP)、日本 Yahoo 购物 / Yahoo 拍卖、Mercari、Biccamera…等等都能寄送。
...
除了提供集运服务之外， **使用乐天集运购买乐天市场的商品** 还额外提供以下保障：
...
可以使用 [官方工具](https://globalexpress.rakuten.co.jp/estimate/?l-id=top_estimate){:target="_blank"} 试算集运运费价格。
...
注册完乐天到 [乐天集运](https://secure.globalexpress.rakuten.co.jp/mypage/register/invite?key=aanar03e62e0ckog4nWPIFcV7FTuy6JGEeCL1HwxrPgcSjKRlGHs1GY6PkH0%3D){:target="_blank"} 预设就是已登入状态。
...
- 集运仓地址务必要输入到最后的 `白石町6–1 RGXセンター XXXXXXX` 英文数字编号，那才是你的专属识别地址。
...
> *有了这个地址跟电话号码就能在日本各大电商网站进行购物跟寄送啰！不过为了确保集运能安全寄回到你手上， **请先「继续完成本人认证手续」再去购物网站购买、寄送商品。***
...
都填好规格内容后点「かごに追加」加入购物车，お届け先 收件人资讯选我们乐天集运的「神奈川县」，下方也会显示预计配送到乐天集运的时间、免运费；都加好后点上方购物车结帐：
...
- **お届け先：** 寄送资讯，可以直接选择刚乐天集运新增的集运地址，或自行新增集运地址(集运地址请务必输入到最后编号部分)
...
收到 HORIE 出货通知后约 1–3 天就送达乐天集运仓库了。



### 从日本亚马逊 Amazon JP 寄送到乐天集运



这次除了买 HORIE 钛杯之外，还从 日本亚马逊 Amazon JP 买了一个杂志，打算一起集运寄回台湾。
...
在购物网站上同样的操作只要记得照乐天集运的你的收件资讯填写寄送地址、联络电话(填集运的)。
...
[乐天集运最长可以免费保管货物 30 天](https://globalexpress.rakuten.co.jp/faq/detail?id=99){:target="_blank"} ，东西都寄到集合好之后就可以请求包装发货啰。
...
到此从日本乐天网站注册、乐天集运使用、下单购物、出货、寄回台湾、EZWay，都完成了，就等货物到手！



### 乐天集运、 [Horie 钛杯](https://a.r10.to/hkPx9m){:target="_blank"} 开箱



10/14 请求乐天集运出货，10/16 就收到了！
...
Horie 钛杯寄送的纸箱原封不动放在乐天集运的纸箱中。



> *感觉可以在集运包装时勾选去除原本的包装减少体积与重量，节省运费。*
